...
var controller3 = {
  ...
  getParams() {
    ...
    const caipAddress = ((_a2 = ChainController.getAccountData(namespace)) == null ? void 0 : _a2.caipAddress) ?? ChainController.state.activeCaipAddress;
    ...
    const invalidToToken = !((_b = state4.toToken) == null ? void 0 : _b.address) || !((_c2 = state4.toToken) == null ? void 0 : _c2.decimals);
    const invalidSourceToken = !((_d = state4.sourceToken) == null ? void 0 : _d.address) || !((_e4 = state4.sourceToken) == null ? void 0 : _e4.decimals) || !NumberUtil.bigNumber(state4.sourceTokenAmount).gt(0);
    const invalidSourceTokenAmount = !state4.sourceTokenAmount;
    return {
      networkAddress,
      fromAddress: address,
      fromCaipAddress: caipAddress,
      sourceTokenAddress: (_f2 = state4.sourceToken) == null ? void 0 : _f2.address,
      toTokenAddress: (_g = state4.toToken) == null ? void 0 : _g.address,
      toTokenAmount: state4.toTokenAmount,
      toTokenDecimals: (_h = state4.toToken) == null ? void 0 : _h.decimals,
      sourceTokenAmount: state4.sourceTokenAmount,
      sourceTokenDecimals: (_i3 = state4.sourceToken) == null ? void 0 : _i3.decimals,
      invalidToToken,
      invalidSourceToken,
  ...
  async swapTokens() {
    ...
    try {
      ...
      const quoteToAmount = (_c2 = (_b = quoteResponse == null ? void 0 : quoteResponse.quotes) == null ? void 0 : _b[0]) == null ? void 0 : _c2.toAmount;
      if (!quoteToAmount) {
...
var ExchangeController = {
  ...
  getTokenAmount() {
    ...
    const bigAmount = NumberUtil.bigNumber(state8.amount ?? 0).round(8);
    const bigPrice = NumberUtil.bigNumber(state8.paymentAsset.price).round(8);
  ...
  async fetchExchanges() {
    ...
    try {
      ...
      const response = await getExchanges({
        ...
        amount: ((_a2 = state8.amount) == null ? void 0 : _a2.toString()) ?? "0"
      });
    ...
    try {
      ...
      if (status.status === "SUCCESS" || status.status === "FAILED") {
        ...
        EventsController.sendEvent({
          ...
          properties: {
            message: status.status === "FAILED" ? CoreHelperUtil.parseError(state8.error) : void 0,
            source: "fund-from-exchange",
            paymentId,
            configuration: {
              network: ((_b = state8.paymentAsset) == null ? void 0 : _b.network) || "",
              asset: ((_c2 = state8.paymentAsset) == null ? void 0 : _c2.asset) || "",
              recipient: address || "",
              amount: state8.amount ?? 0
            },
            currentPayment: {
              type: "exchange",
              exchangeId: (_d = state8.currentPayment) == null ? void 0 : _d.exchangeId,
              sessionId: (_e4 = state8.currentPayment) == null ? void 0 : _e4.sessionId,
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-LJRYFGDZ.js");
  const signature_ = (() => {
...
var UiHelperUtil = {
  ...
  maskInput({ value, decimals, integers }) {
    ...
    const [integerPart = "", decimalsPart] = value.split(DECIMAL_POINT).map((p2) => p2.replace(/[^0-9]/gu, ""));
...
var TransactionUtil = {
  ...
  getTransactionDescriptions(transaction, mergedTransfers) {
    ...
    const hasTransfer = (transfers == null ? void 0 : transfers.length) > 0;
    const hasMultipleTransfers = (transfers == null ? void 0 : transfers.length) > 1;
    const isFungible = hasTransfer && (transfers == null ? void 0 : transfers.every((transfer) => Boolean(transfer == null ? void 0 : transfer.fungible_info)));
  ...
  mergeTransfers(transfers) {
    ...
    const mergedTransfers = filteredTransfers.reduce((acc, t) => {
      var _a2;
      const name = (_a2 = t == null ? void 0 : t.fungible_info) == null ? void 0 : _a2.name;
    ...
    if (mergedTransfers.length > 2) {
      finalTransfers = mergedTransfers.sort((a2, b3) => (b3.value || 0) - (a2.value || 0)).slice(0, 2);
    }
    finalTransfers = finalTransfers.sort((a2, b3) => {
      if (a2.direction === "out" && b3.direction === "in") {
        return -1;
      }
      if (a2.direction === "in" && b3.direction === "out") {
        return 1;
      }
      return 0;
    });
  ...
  filterGasFeeTransfers(transfers) {
    const tokenGroups = transfers.reduce((groups, transfer) => {
      var _a2;
      const tokenName = (_a2 = transfer == null ? void 0 : transfer.fungible_info) == null ? void 0 : _a2.name;
      if (tokenName) {
        if (!groups[tokenName]) {
          groups[tokenName] = [];
        }
    ...
    transfers.forEach((transfer) => {
      var _a2;
      if (!((_a2 = transfer == null ? void 0 : transfer.fungible_info) == null ? void 0 : _a2.name)) {
...
*/
//# sourceMappingURL=chunk-QQ7MWM6W.js.map
