...
import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-ZCQJO3MT.js";
import {
  CaipNetworksUtil,
  ConstantsUtil as ConstantsUtil3,
  ErrorUtil as ErrorUtil2,
  HelpersUtil
} from "./chunk-ODAPH2P5.js";
import {
  W3mFrameProvider
} from "./chunk-WKZPPMDW.js";
import {
  AlertController,
  MathUtil,
...
WuiActiveProfileWalletItem.styles = [resetStyles, elementStyles, styles_default17];
__decorate22([
  property()
...
WuiActiveProfileWalletItem = __decorate22([
...
WuiInactiveProfileWalletItem.styles = [resetStyles, elementStyles, styles_default18];
__decorate23([
  property()
...
WuiInactiveProfileWalletItem = __decorate23([
...
W3mProfileWalletsView.styles = styles_default19;
__decorate24([
  state()
...
W3mProfileWalletsView = __decorate24([
...
WuiToggle.styles = [resetStyles, elementStyles, styles_default20];
__decorate25([
  property({ type: Boolean })
...
WuiCertifiedSwitch.styles = [resetStyles, elementStyles, styles_default21];
__decorate26([
  property({ type: Boolean })
...
WuiSearchBar.styles = [resetStyles, styles_default22];
__decorate27([
  property()
...
WuiCardSelectLoader.styles = [resetStyles, elementStyles, styles_default23];
__decorate28([
  property()
...
WuiGrid.styles = [resetStyles, styles_default24];
__decorate29([
  property()
...
W3mAllWalletsListItem.styles = styles_default25;
__decorate30([
  state()
...
W3mAllWalletsList.styles = styles_default26;
__decorate31([
  state()
...
W3mAllWalletsSearch.styles = styles_default27;
__decorate32([
  state()
...
WuiListButton.styles = [resetStyles, elementStyles, styles_default28];
__decorate34([
  property()
...
W3mEmailLoginWidget.styles = styles_default29;
__decorate35([
  property()
...
WuiLogoSelect.styles = [resetStyles, elementStyles, styles_default30];
__decorate36([
  property()
...
W3mSocialLoginWidget.styles = styles_default31;
__decorate37([
  property()
  ...
  render() {
    ...
    return html`
      <wui-flex flexDirection="column" gap="2">
        ${repeat(announcedConnectors.filter(ConnectorUtil.showConnector), (connector) => connector.id, (connector) => {
      var _a, _b;
...
W3mConnectAnnouncedWidget = __decorate39([
...
W3mConnectCustomWidget = __decorate40([
    ...
    return html`
      ...
      return html`
            <w3m-list-wallet
              ...
              tabIdx=${ifDefined(this.tabIdx)}
              ?disabled=${hasWcConnection}
              rdnsId=${(_a = connector.explorerWallet) == null ? void 0 : _a.rdns}
              walletRank=${(_b = connector.explorerWallet) == null ? void 0 : _b.order}
            >
            </w3m-list-wallet>
          `;
    })}
...
W3mConnectExternalWidget = __decorate41([
...
W3mConnectFeaturedWidget = __decorate42([
...
W3mConnectInjectedWidget = __decorate43([
...
W3mConnectMultiChainWidget = __decorate44([
...
W3mConnectRecentWidget = __decorate45([
...
W3mConnectRecommendedWidget = __decorate46([
...
W3mConnectWalletConnectWidget = __decorate47([
...
var W3mConnectorList = class W3mConnectorList2 extends LitElement {
  constructor() {
    ...
    this.unsubscribe.push(ConnectorController.subscribeKey("connectors", (val) => this.connectors = val), ApiController.subscribeKey("recommended", (val) => this.recommended = val), ApiController.subscribeKey("featured", (val) => this.featured = val), ApiController.subscribeKey("explorerFilteredWallets", (val) => {
  ...
  mapConnectorsToExplorerWallets(connectors, explorerWallets) {
    return connectors.map((connector) => {
      if (connector.type === "MULTI_CHAIN" && connector.connectors) {
        ...
        const explorerWallet2 = explorerWallets == null ? void 0 : explorerWallets.find((wallet) => connectorIds.includes(wallet.id) || connectorNames.includes(wallet.name) || wallet.rdns && (connectorRdns.includes(wallet.rdns) || connectorIds.includes(wallet.rdns)));
        connector.explorerWallet = explorerWallet2 ?? connector.explorerWallet;
        return connector;
      }
      const explorerWallet = explorerWallets == null ? void 0 : explorerWallets.find((wallet) => {
        var _a;
        return wallet.id === connector.id || wallet.rdns === ((_a = connector.info) == null ? void 0 : _a.rdns) || wallet.name === connector.name;
      });
...
W3mConnectorList.styles = styles_default32;
__decorate48([
  property({ type: Number })
...
W3mWalletLoginList = __decorate49([
...
W3mConnectView.styles = styles_default33;
__decorate50([
  state()
...
WuiCtaButton.styles = [resetStyles, elementStyles, styles_default34];
__decorate51([
  property({ type: Boolean })
...
W3mMobileDownloadLinks.styles = [styles_default35];
__decorate52([
  property({ type: Object })
...
W3mConnectingWidget.styles = styles_default36;
__decorate53([
  state()
        ...
        if (this.connector.id !== ConstantsUtil.CONNECTOR_ID.COINBASE_SDK || !this.error) {
          ...
          EventsController.sendEvent({
            ...
            properties: {
              ...
              name: this.connector.name || "Unknown",
              view: RouterController.state.view,
              walletRank: (_a = this.wallet) == null ? void 0 : _a.order
            }
          });
        }
      }
...
W3mConnectingExternalView = __decorate54([
...
var W3mConnectingMultiChainView = class W3mConnectingMultiChainView2 extends LitElement {
  ...
  networksTemplate() {
    var _a, _b;
    return (_b = (_a = this.activeConnector) == null ? void 0 : _a.connectors) == null ? void 0 : _b.map((connector) => {
      var _a2;
...
W3mConnectingMultiChainView.styles = styles_default37;
__decorate55([
  state()
], W3mConnectingMultiChainView.prototype, "activeConnector", void 0);
W3mConnectingMultiChainView = __decorate55([
  ...
  async onConnectProxy() {
    ...
    try {
      ...
      const connector = connectors.find((c) => {
        var _a2, _b2, _c;
        return c.type === "ANNOUNCED" && ((_a2 = c.info) == null ? void 0 : _a2.rdns) === ((_b2 = this.wallet) == null ? void 0 : _b2.rdns) || c.type === "INJECTED" || c.name === ((_c = this.wallet) == null ? void 0 : _c.name);
      });
      if (connector) {
...
var W3mConnectingWcQrcode = class W3mConnectingWcQrcode2 extends W3mConnectingWidget {
  ...
  qrCodeTemplate() {
    ...
    if ((_a = this.wallet) == null ? void 0 : _a.mobile_link) {
      const { redirect } = CoreHelperUtil.formatNativeUrl((_b = this.wallet) == null ? void 0 : _b.mobile_link, this.uri, null);
...
W3mConnectingWcView.styles = styles_default39;
__decorate63([
  state()
...
W3mConnectingWcView = __decorate63([
...
W3mConnectingWcBasicView = __decorate64([
...
W3mChooseAccountNameView.styles = styles_default40;
__decorate65([
  state()
], W3mChooseAccountNameView.prototype, "loading", void 0);
W3mChooseAccountNameView = __decorate65([
...
W3mWhatIsAWalletView = __decorate69([
...
W3mConnectWalletsView.styles = styles_default41;
__decorate70([
  state()
], W3mConnectWalletsView.prototype, "checked", void 0);
W3mConnectWalletsView = __decorate70([
...
WuiLoadingHexagon.styles = [resetStyles, styles_default42];
WuiLoadingHexagon = __decorate71([
...
W3mNetworkSwitchView.styles = styles_default43;
__decorate72([
  state()
...
W3mNetworkSwitchView = __decorate72([
...
WuiListNetwork.styles = [resetStyles, elementStyles, styles_default44];
__decorate73([
  property()
...
W3mNetworksView.styles = styles_default45;
__decorate74([
  state()
...
W3mSwitchActiveChainView.styles = styles_default46;
__decorate75([
  property()
], W3mSwitchActiveChainView.prototype, "activeChain", void 0);
W3mSwitchActiveChainView = __decorate75([
...
W3mWhatIsANetworkView = __decorate76([
...
W3mUnsupportedChainView.styles = styles_default47;
__decorate77([
  state()
...
W3mUnsupportedChainView = __decorate77([
...
WuiBanner.styles = [resetStyles, elementStyles, styles_default48];
__decorate78([
  property()
...
W3mWalletCompatibleNetworksView.styles = styles_default49;
W3mWalletCompatibleNetworksView = __decorate79([
...
WuiVisualThumbnail = __decorate80([
...
W3mSIWXSignMessageThumbnails.styles = styles_default51;
W3mSIWXSignMessageThumbnails = __decorate81([
...
W3mSIWXSignMessageView = __decorate82([
...
lit-html/development/directives/repeat.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RSVYAXR7.js.map
