...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-3V6IAE5R.js");
  const signature_ = (() => {
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-OF4KNWFO.js").then((module) => module.WebSocket);
...
async function signTransaction(client, parameters) {
  ...
  return await client.request({
    ...
    params: [
      {
        ...format(transaction, "signTransaction"),
...
//# sourceMappingURL=chunk-MTYHTLTY.js.map
