...
} from "./chunk-LQHVTAS5.js";
import {
  formatUnits
} from "./chunk-PYTMSYRP.js";
import {
  __toESM
...
var CoreHelperUtil = {
  ...
  isPWA() {
    ...
    const isIOSStandalone = (_c3 = window == null ? void 0 : window.navigator) == null ? void 0 : _c3.standalone;
  ...
  goBack() {
    ...
    setTimeout(() => {
      ...
      if (shouldReload) {
        ...
        (_c3 = (_b = authConnector == null ? void 0 : authConnector.provider) == null ? void 0 : _b.syncDappData) == null ? void 0 : _c3.call(_b, {
...
var controller8 = {
  ...
  getEnabledNamespaces() {
    return Object.entries(state14.filterByNamespaceMap).filter(([_2, enabled]) => enabled).map(([namespace]) => namespace);
  },
  ...
  getUniqueConnectorsByName(connectors) {
    ...
    connectors.forEach((c4) => {
      if (!uniqueConnectors.find((uc3) => uc3.chain === c4.chain)) {
...
var controller10 = {
  ...
  async connectWalletConnect() {
    ...
    if (CoreHelperUtil.isTelegram() || CoreHelperUtil.isSafari() && CoreHelperUtil.isIos()) {
      ...
      await ((_d = (_c3 = ConnectionController._getClient()) == null ? void 0 : _c3.connectWalletConnect) == null ? void 0 : _d.call(_c3));
    }
  },
    ...
    if ((_b = SendController.state.token) == null ? void 0 : _b.address) {
      EventsController.sendEvent({
        ...
        properties: {
          ...
          network: ((_c3 = ChainController.state.activeCaipNetwork) == null ? void 0 : _c3.caipNetworkId) || ""
        }
      });
...
var controller12 = {
  ...
  setActiveCaipNetwork(caipNetwork) {
    ...
    PublicStateController.set({
      ...
      selectedNetworkId: (_c3 = state18.activeCaipNetwork) == null ? void 0 : _c3.caipNetworkId
    });
  ...
  getCaipNetworkByNamespace(chainNamespace, chainId) {
    ...
    return ((_b = chain == null ? void 0 : chain.networkState) == null ? void 0 : _b.caipNetwork) || ((_c3 = chain == null ? void 0 : chain.caipNetworks) == null ? void 0 : _c3[0]);
  },
  /**
...
// node_modules/@walletconnect/ethereum-provider/node_modules/unstorage/dist/shared/unstorage.zVDD2mZo.mjs
...
// node_modules/@walletconnect/ethereum-provider/node_modules/unstorage/dist/index.mjs
...
// node_modules/@walletconnect/ethereum-provider/node_modules/@walletconnect/keyvaluestorage/dist/index.es.js
var x = "idb-keyval";
var z = (i3 = {}) => {
...
var O = async (i3, t2, e2) => {
  const n3 = N, s2 = await t2.getItem(n3);
  if (s2 && s2 >= y3) {
    e2(t2);
    return;
  }
  ...
  for (; a2.length; ) {
    ...
    if (o2.includes("wc@") || o2.includes("walletconnect") || o2.includes("wc_") || o2.includes("wallet_connect")) {
      ...
      await t2.setItem(r2, f7), m2.push(r2);
    }
  }
  await t2.setItem(n3, y3), e2(t2), j(i3, m2);
};
var j = async (i3, t2) => {
...
function si({ protocol: t2, version: e2, relayUrl: n3, sdkVersion: r2, auth: o2, projectId: i3, useOnCloseEvent: s2, bundleId: c4, packageName: a2 }) {
  const u3 = n3.split("?"), l5 = Mn(t2, e2, r2), f7 = { auth: o2, ua: l5, projectId: i3, useOnCloseEvent: s2 || void 0, packageName: a2 || void 0, bundleId: c4 || void 0 }, h4 = Cn(u3[1] || "", f7);
  return u3[0] + "?" + h4;
}
function fi(t2) {
...
function gi(t2 = import_time.FIVE_MINUTES, e2) {
  ...
  let r2, o2, i3, s2;
  return { resolve: (c4) => {
    i3 && r2 && (clearTimeout(i3), r2(c4), s2 = Promise.resolve(c4));
  }, reject: (c4) => {
...
function Zi(t2, e2 = 24) {
  ...
  for (let r2 = 24 - e2; r2 < 24; r2++) {
    ...
    for (let s2 = 0; s2 < 10; s2 += 2) {
      const c4 = (s2 + 8) % 10, a2 = (s2 + 2) % 10, u3 = n3[a2], l5 = n3[a2 + 1], f7 = rr(u3, l5, 1) ^ n3[c4], h4 = or(u3, l5, 1) ^ n3[c4 + 1];
      for (let y6 = 0; y6 < 50; y6 += 10) t2[s2 + y6] ^= f7, t2[s2 + y6 + 1] ^= h4;
    }
    let o2 = t2[2], i3 = t2[3];
    for (let s2 = 0; s2 < 24; s2++) {
      const c4 = er[s2], a2 = rr(o2, i3, c4), u3 = or(o2, i3, c4), l5 = tr[s2];
      o2 = t2[l5], i3 = t2[l5 + 1], t2[l5] = a2, t2[l5 + 1] = u3;
    }
    for (let s2 = 0; s2 < 50; s2 += 10) {
      for (let c4 = 0; c4 < 10; c4++) n3[c4] = t2[s2 + c4];
      for (let c4 = 0; c4 < 10; c4++) t2[s2 + c4] ^= ~n3[(c4 + 2) % 10] & n3[(c4 + 4) % 10];
    }
...
var En = class _En extends ke {
  ...
  update(e2) {
    ...
    for (let i3 = 0; i3 < o2; ) {
      ...
      for (let c4 = 0; c4 < s2; c4++) r2[this.pos++] ^= e2[i3++];
...
var Es = (t2, e2) => {
  function n3(r2, ...o2) {
    if (tt(r2), t2.nonceLength !== void 0) {
      ...
      t2.varSizeNonce ? tt(l5) : tt(l5, t2.nonceLength);
    }
    const i3 = t2.tagLength;
    i3 && o2[1] !== void 0 && tt(o2[1]);
    const s2 = e2(r2, ...o2), c4 = (l5, f7) => {
      if (f7 !== void 0) {
    ...
    let a2 = false;
    return { encrypt(l5, f7) {
      if (a2) throw new Error("cannot encrypt() twice with same key + nonce");
      return a2 = true, tt(l5), c4(s2.encrypt.length, f7), s2.encrypt(l5, f7);
    }, decrypt(l5, f7) {
      if (tt(l5), i3 && l5.length < i3) throw new Error("invalid ciphertext length: smaller than tagLength=" + i3);
      return c4(s2.decrypt.length, f7), s2.decrypt(l5, f7);
    } };
  }
...
function Ir(t2, e2, n3, r2) {
  ...
  const o2 = BigInt(32), i3 = BigInt(4294967295), s2 = Number(n3 >> o2 & i3), c4 = Number(n3 & i3), a2 = r2 ? 4 : 0, u3 = r2 ? 0 : 4;
  t2.setUint32(e2 + a2, s2, r2), t2.setUint32(e2 + u3, c4, r2);
}
function vs(t2) {
...
function Is(t2, e2, n3, r2, o2, i3, s2, c4) {
  const a2 = o2.length, u3 = new Uint8Array(ge), l5 = mt(u3), f7 = Ye(o2) && Ye(i3), h4 = f7 ? mt(o2) : Tr, y6 = f7 ? mt(i3) : Tr;
  for (let E4 = 0; E4 < a2; s2++) {
    if (t2(e2, n3, r2, l5, s2, c4), s2 >= Ur) throw new Error("arx: counter overflow");
    const p3 = Math.min(ge, a2 - E4);
    if (f7 && p3 === ge) {
      const d2 = E4 / 4;
      if (E4 % 4 !== 0) throw new Error("arx: invalid block position");
      for (let v3 = 0, m2; v3 < Bs; v3++) m2 = d2 + v3, y6[m2] = h4[m2] ^ l5[v3];
      E4 += ge;
      continue;
    }
    for (let d2 = 0, v3; d2 < p3; d2++) v3 = E4 + d2, i3[v3] = o2[v3] ^ u3[d2];
    E4 += p3;
  }
}
function Ns(t2, e2) {
  ...
  return Fe(o2), Fe(s2), Ar(i3), Ar(n3), (c4, a2, u3, l5, f7 = 0) => {
    tt(c4), tt(a2), tt(u3);
    const h4 = u3.length;
    if (l5 === void 0 && (l5 = new Uint8Array(h4)), tt(l5), Fe(f7), f7 < 0 || f7 >= Ur) throw new Error("arx: counter overflow");
    if (l5.length < h4) throw new Error(`arx: output (${l5.length}) is shorter than data (${h4})`);
    const y6 = [];
    let E4 = c4.length, p3, d2;
    if (E4 === 32) y6.push(p3 = Ze(c4)), d2 = As;
    else if (E4 === 16 && n3) p3 = new Uint8Array(32), p3.set(c4), p3.set(c4, 16), d2 = Os, y6.push(p3);
    ...
    if (m2 !== 12) {
      ...
      N2.set(a2, i3 ? 0 : 12 - a2.length), a2 = N2, y6.push(a2);
    }
    const O4 = mt(a2);
    return Is(t2, d2, v3, O4, u3, l5, f7, s2), jt(...y6), l5;
  };
}
...
var Us = class {
  constructor(e2) {
    ...
    const n3 = F(e2, 0), r2 = F(e2, 2), o2 = F(e2, 4), i3 = F(e2, 6), s2 = F(e2, 8), c4 = F(e2, 10), a2 = F(e2, 12), u3 = F(e2, 14);
    this.r[0] = n3 & 8191, this.r[1] = (n3 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o2 << 6) & 7939, this.r[3] = (o2 >>> 7 | i3 << 9) & 8191, this.r[4] = (i3 >>> 4 | s2 << 12) & 255, this.r[5] = s2 >>> 1 & 8190, this.r[6] = (s2 >>> 14 | c4 << 2) & 8191, this.r[7] = (c4 >>> 11 | a2 << 5) & 8065, this.r[8] = (a2 >>> 8 | u3 << 8) & 8191, this.r[9] = u3 >>> 5 & 127;
    for (let l5 = 0; l5 < 8; l5++) this.pad[l5] = F(e2, 16 + 2 * l5);
  }
  process(e2, n3, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i3, r: s2 } = this, c4 = s2[0], a2 = s2[1], u3 = s2[2], l5 = s2[3], f7 = s2[4], h4 = s2[5], y6 = s2[6], E4 = s2[7], p3 = s2[8], d2 = s2[9], v3 = F(e2, n3 + 0), m2 = F(e2, n3 + 2), O4 = F(e2, n3 + 4), N2 = F(e2, n3 + 6), $2 = F(e2, n3 + 8), B3 = F(e2, n3 + 10), A3 = F(e2, n3 + 12), T = F(e2, n3 + 14);
    let S3 = i3[0] + (v3 & 8191), L2 = i3[1] + ((v3 >>> 13 | m2 << 3) & 8191), U4 = i3[2] + ((m2 >>> 10 | O4 << 6) & 8191), _2 = i3[3] + ((O4 >>> 7 | N2 << 9) & 8191), j2 = i3[4] + ((N2 >>> 4 | $2 << 12) & 8191), g = i3[5] + ($2 >>> 1 & 8191), w2 = i3[6] + (($2 >>> 14 | B3 << 2) & 8191), b2 = i3[7] + ((B3 >>> 11 | A3 << 5) & 8191), I2 = i3[8] + ((A3 >>> 8 | T << 8) & 8191), R3 = i3[9] + (T >>> 5 | o2), x2 = 0, C4 = x2 + S3 * c4 + L2 * (5 * d2) + U4 * (5 * p3) + _2 * (5 * E4) + j2 * (5 * y6);
    x2 = C4 >>> 13, C4 &= 8191, C4 += g * (5 * h4) + w2 * (5 * f7) + b2 * (5 * l5) + I2 * (5 * u3) + R3 * (5 * a2), x2 += C4 >>> 13, C4 &= 8191;
    let P3 = x2 + S3 * a2 + L2 * c4 + U4 * (5 * d2) + _2 * (5 * p3) + j2 * (5 * E4);
    x2 = P3 >>> 13, P3 &= 8191, P3 += g * (5 * y6) + w2 * (5 * h4) + b2 * (5 * f7) + I2 * (5 * l5) + R3 * (5 * u3), x2 += P3 >>> 13, P3 &= 8191;
    let k4 = x2 + S3 * u3 + L2 * a2 + U4 * c4 + _2 * (5 * d2) + j2 * (5 * p3);
    x2 = k4 >>> 13, k4 &= 8191, k4 += g * (5 * E4) + w2 * (5 * y6) + b2 * (5 * h4) + I2 * (5 * f7) + R3 * (5 * l5), x2 += k4 >>> 13, k4 &= 8191;
    let M3 = x2 + S3 * l5 + L2 * u3 + U4 * a2 + _2 * c4 + j2 * (5 * d2);
    x2 = M3 >>> 13, M3 &= 8191, M3 += g * (5 * p3) + w2 * (5 * E4) + b2 * (5 * y6) + I2 * (5 * h4) + R3 * (5 * f7), x2 += M3 >>> 13, M3 &= 8191;
    let D2 = x2 + S3 * f7 + L2 * l5 + U4 * u3 + _2 * a2 + j2 * c4;
    x2 = D2 >>> 13, D2 &= 8191, D2 += g * (5 * d2) + w2 * (5 * p3) + b2 * (5 * E4) + I2 * (5 * y6) + R3 * (5 * h4), x2 += D2 >>> 13, D2 &= 8191;
    let z3 = x2 + S3 * h4 + L2 * f7 + U4 * l5 + _2 * u3 + j2 * a2;
    x2 = z3 >>> 13, z3 &= 8191, z3 += g * c4 + w2 * (5 * d2) + b2 * (5 * p3) + I2 * (5 * E4) + R3 * (5 * y6), x2 += z3 >>> 13, z3 &= 8191;
    let Z2 = x2 + S3 * y6 + L2 * h4 + U4 * f7 + _2 * l5 + j2 * u3;
    x2 = Z2 >>> 13, Z2 &= 8191, Z2 += g * a2 + w2 * c4 + b2 * (5 * d2) + I2 * (5 * p3) + R3 * (5 * E4), x2 += Z2 >>> 13, Z2 &= 8191;
    let st2 = x2 + S3 * E4 + L2 * y6 + U4 * h4 + _2 * f7 + j2 * l5;
    x2 = st2 >>> 13, st2 &= 8191, st2 += g * u3 + w2 * a2 + b2 * c4 + I2 * (5 * d2) + R3 * (5 * p3), x2 += st2 >>> 13, st2 &= 8191;
    let W2 = x2 + S3 * p3 + L2 * E4 + U4 * y6 + _2 * h4 + j2 * f7;
    x2 = W2 >>> 13, W2 &= 8191, W2 += g * l5 + w2 * u3 + b2 * a2 + I2 * c4 + R3 * (5 * d2), x2 += W2 >>> 13, W2 &= 8191;
    let J2 = x2 + S3 * d2 + L2 * p3 + U4 * E4 + _2 * y6 + j2 * h4;
    x2 = J2 >>> 13, J2 &= 8191, J2 += g * f7 + w2 * l5 + b2 * u3 + I2 * a2 + R3 * c4, x2 += J2 >>> 13, J2 &= 8191, x2 = (x2 << 2) + x2 | 0, x2 = x2 + C4 | 0, C4 = x2 & 8191, x2 = x2 >>> 13, P3 += x2, i3[0] = C4, i3[1] = P3, i3[2] = k4, i3[3] = M3, i3[4] = D2, i3[5] = z3, i3[6] = Z2, i3[7] = st2, i3[8] = W2, i3[9] = J2;
  }
  finalize() {
    ...
    i3 = ~i3;
    for (let c4 = 0; c4 < 10; c4++) e2[c4] = e2[c4] & i3 | r2[c4];
    ...
    let s2 = e2[0] + n3[0];
    e2[0] = s2 & 65535;
    for (let c4 = 1; c4 < 8; c4++) s2 = (e2[c4] + n3[c4] | 0) + (s2 >>> 16) | 0, e2[c4] = s2 & 65535;
    jt(r2);
  }
  update(e2) {
    Or(this);
...
function _s(t2, e2, n3, r2, o2, i3 = 20) {
  let s2 = t2[0], c4 = t2[1], a2 = t2[2], u3 = t2[3], l5 = e2[0], f7 = e2[1], h4 = e2[2], y6 = e2[3], E4 = e2[4], p3 = e2[5], d2 = e2[6], v3 = e2[7], m2 = o2, O4 = n3[0], N2 = n3[1], $2 = n3[2], B3 = s2, A3 = c4, T = a2, S3 = u3, L2 = l5, U4 = f7, _2 = h4, j2 = y6, g = E4, w2 = p3, b2 = d2, I2 = v3, R3 = m2, x2 = O4, C4 = N2, P3 = $2;
  for (let M3 = 0; M3 < i3; M3 += 2) B3 = B3 + L2 | 0, R3 = V(R3 ^ B3, 16), g = g + R3 | 0, L2 = V(L2 ^ g, 12), B3 = B3 + L2 | 0, R3 = V(R3 ^ B3, 8), g = g + R3 | 0, L2 = V(L2 ^ g, 7), A3 = A3 + U4 | 0, x2 = V(x2 ^ A3, 16), w2 = w2 + x2 | 0, U4 = V(U4 ^ w2, 12), A3 = A3 + U4 | 0, x2 = V(x2 ^ A3, 8), w2 = w2 + x2 | 0, U4 = V(U4 ^ w2, 7), T = T + _2 | 0, C4 = V(C4 ^ T, 16), b2 = b2 + C4 | 0, _2 = V(_2 ^ b2, 12), T = T + _2 | 0, C4 = V(C4 ^ T, 8), b2 = b2 + C4 | 0, _2 = V(_2 ^ b2, 7), S3 = S3 + j2 | 0, P3 = V(P3 ^ S3, 16), I2 = I2 + P3 | 0, j2 = V(j2 ^ I2, 12), S3 = S3 + j2 | 0, P3 = V(P3 ^ S3, 8), I2 = I2 + P3 | 0, j2 = V(j2 ^ I2, 7), B3 = B3 + U4 | 0, P3 = V(P3 ^ B3, 16), b2 = b2 + P3 | 0, U4 = V(U4 ^ b2, 12), B3 = B3 + U4 | 0, P3 = V(P3 ^ B3, 8), b2 = b2 + P3 | 0, U4 = V(U4 ^ b2, 7), A3 = A3 + _2 | 0, R3 = V(R3 ^ A3, 16), I2 = I2 + R3 | 0, _2 = V(_2 ^ I2, 12), A3 = A3 + _2 | 0, R3 = V(R3 ^ A3, 8), I2 = I2 + R3 | 0, _2 = V(_2 ^ I2, 7), T = T + j2 | 0, x2 = V(x2 ^ T, 16), g = g + x2 | 0, j2 = V(j2 ^ g, 12), T = T + j2 | 0, x2 = V(x2 ^ T, 8), g = g + x2 | 0, j2 = V(j2 ^ g, 7), S3 = S3 + L2 | 0, C4 = V(C4 ^ S3, 16), w2 = w2 + C4 | 0, L2 = V(L2 ^ w2, 12), S3 = S3 + L2 | 0, C4 = V(C4 ^ S3, 8), w2 = w2 + C4 | 0, L2 = V(L2 ^ w2, 7);
  let k4 = 0;
  r2[k4++] = s2 + B3 | 0, r2[k4++] = c4 + A3 | 0, r2[k4++] = a2 + T | 0, r2[k4++] = u3 + S3 | 0, r2[k4++] = l5 + L2 | 0, r2[k4++] = f7 + U4 | 0, r2[k4++] = h4 + _2 | 0, r2[k4++] = y6 + j2 | 0, r2[k4++] = E4 + g | 0, r2[k4++] = p3 + w2 | 0, r2[k4++] = d2 + b2 | 0, r2[k4++] = v3 + I2 | 0, r2[k4++] = m2 + R3 | 0, r2[k4++] = O4 + x2 | 0, r2[k4++] = N2 + C4 | 0, r2[k4++] = $2 + P3 | 0;
}
...
var Cs = (t2) => (e2, n3, r2) => ({ encrypt(i3, s2) {
  const c4 = i3.length;
  s2 = Br(c4 + 16, s2, false), s2.set(i3);
  const a2 = s2.subarray(0, -16);
  t2(e2, n3, a2, a2, 1);
  const u3 = _r(t2, e2, n3, a2, r2);
  return s2.set(u3, c4), jt(u3), s2;
}, decrypt(i3, s2) {
  s2 = Br(i3.length - 16, s2, false);
  const c4 = i3.subarray(0, -16), a2 = i3.subarray(-16), u3 = _r(t2, e2, n3, c4, r2);
...
var Lr = class extends ke {
  ...
  _cloneInto(e2) {
    ...
    const { oHash: n3, iHash: r2, finished: o2, destroyed: i3, blockLen: s2, outputLen: c4 } = this;
    return e2 = e2, e2.finished = o2, e2.destroyed = i3, e2.blockLen = s2, e2.outputLen = c4, e2.oHash = n3._cloneInto(e2.oHash), e2.iHash = r2._cloneInto(e2.iHash), e2;
  }
  destroy() {
...
function ks(t2, e2, n3, r2 = 32) {
  ...
  n3 === void 0 && (n3 = jr);
  const i3 = new Uint8Array(o2 * t2.outputLen), s2 = ye.create(t2, e2), c4 = s2._cloneInto(), a2 = new Uint8Array(s2.outputLen);
  for (let u3 = 0; u3 < o2; u3++) Ge[0] = u3 + 1, c4.update(u3 === 0 ? jr : a2).update(n3).update(Ge).digestInto(a2), i3.set(a2, t2.outputLen * u3), s2._cloneInto(c4);
  return s2.destroy(), c4.destroy(), a2.fill(0), Ge.fill(0), i3.slice(0, r2);
}
...
var qs = class extends ke {
  ...
  update(e2) {
    ...
    const i3 = e2.length;
    for (let s2 = 0; s2 < i3; ) {
      const c4 = Math.min(o2 - this.pos, i3 - s2);
      if (c4 === o2) {
        const a2 = Pe(e2);
        for (; o2 <= i3 - s2; s2 += o2) this.process(a2, s2);
        continue;
      }
      r2.set(e2.subarray(s2, s2 + c4), this.pos), this.pos += c4, s2 += c4, this.pos === o2 && (this.process(n3, 0), this.pos = 0);
    }
  ...
  digestInto(e2) {
    ...
    const u3 = a2 / 4, l5 = this.get();
    if (u3 > l5.length) throw new Error("_sha2: outputLen bigger than state");
    for (let f7 = 0; f7 < u3; f7++) c4.setUint32(4 * f7, l5[f7], i3);
  }
  digest() {
    const { buffer: e2, outputLen: n3 } = this;
    this.digestInto(e2);
  ...
  _cloneInto(e2) {
    ...
    const { blockLen: n3, buffer: r2, length: o2, finished: i3, destroyed: s2, pos: c4 } = this;
    return e2.length = o2, e2.pos = c4, e2.finished = i3, e2.destroyed = s2, o2 % n3 && e2.buffer.set(r2), e2;
  }
};
...
var Fs = class extends qs {
  ...
  get() {
    const { A: e2, B: n3, C: r2, D: o2, E: i3, F: s2, G: c4, H: a2 } = this;
    return [e2, n3, r2, o2, i3, s2, c4, a2];
  }
  set(e2, n3, r2, o2, i3, s2, c4, a2) {
    this.A = e2 | 0, this.B = n3 | 0, this.C = r2 | 0, this.D = o2 | 0, this.E = i3 | 0, this.F = s2 | 0, this.G = c4 | 0, this.H = a2 | 0;
  }
  process(e2, n3) {
    for (let f7 = 0; f7 < 16; f7++, n3 += 4) bt[f7] = e2.getUint32(n3, false);
    for (let f7 = 16; f7 < 64; f7++) {
      const h4 = bt[f7 - 15], y6 = bt[f7 - 2], E4 = ct(h4, 7) ^ ct(h4, 18) ^ h4 >>> 3, p3 = ct(y6, 17) ^ ct(y6, 19) ^ y6 >>> 10;
      bt[f7] = p3 + bt[f7 - 7] + E4 + bt[f7 - 16] | 0;
    }
    let { A: r2, B: o2, C: i3, D: s2, E: c4, F: a2, G: u3, H: l5 } = this;
    for (let f7 = 0; f7 < 64; f7++) {
      const h4 = ct(c4, 6) ^ ct(c4, 11) ^ ct(c4, 25), y6 = l5 + h4 + Ds(c4, a2, u3) + Ks[f7] + bt[f7] | 0, p3 = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i3) | 0;
      l5 = u3, u3 = a2, a2 = c4, c4 = s2 + y6 | 0, s2 = i3, i3 = o2, o2 = r2, r2 = y6 + p3 | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, i3 = i3 + this.C | 0, s2 = s2 + this.D | 0, c4 = c4 + this.E | 0, a2 = a2 + this.F | 0, u3 = u3 + this.G | 0, l5 = l5 + this.H | 0, this.set(r2, o2, i3, s2, c4, a2, u3, l5);
  }
  roundClean() {
    bt.fill(0);
  }
...
function Vt(t2) {
  ...
  for (let o2 = 0, i3 = 0; o2 < n3; o2++, i3 += 2) {
    const s2 = Cr(t2.charCodeAt(i3)), c4 = Cr(t2.charCodeAt(i3 + 1));
...
function Dt(t2, e2, n3 = {}) {
  const r2 = (o2, i3, s2) => {
    ...
    const a2 = t2[o2];
    if (!(s2 && a2 === void 0) && !c4(a2, t2)) throw new Error("param " + String(o2) + " is invalid. Expected " + i3 + ", got " + a2);
  };
...
function nn(t2, e2) {
  ...
  for (; n3 !== q; ) {
    const c4 = r2 / n3, a2 = r2 % n3, u3 = o2 - i3 * c4;
...
function rc(t2) {
  ...
  if (r2 === 1) {
    ...
    return function(a2, u3) {
      const l5 = a2.pow(u3, s2);
      if (!a2.eql(a2.sqr(l5), u3)) throw new Error("Cannot find square root");
      return l5;
    };
  }
  const i3 = (n3 + H) / At;
  return function(c4, a2) {
    ...
    let u3 = r2, l5 = c4.pow(c4.mul(c4.ONE, o2), n3), f7 = c4.pow(a2, i3), h4 = c4.pow(a2, n3);
    for (; !c4.eql(h4, c4.ONE); ) {
      if (c4.eql(h4, c4.ZERO)) return c4.ZERO;
      let y6 = 1;
      for (let p3 = c4.sqr(h4); y6 < u3 && !c4.eql(p3, c4.ONE); y6++) p3 = c4.sqr(p3);
      const E4 = c4.pow(l5, H << BigInt(u3 - y6 - 1));
      l5 = c4.sqr(E4), f7 = c4.mul(f7, E4), h4 = c4.mul(h4, l5), u3 = y6;
    }
    return f7;
  };
}
function oc(t2) {
  ...
  if (t2 % Dr === Mr) {
    const e2 = (t2 - Mr) / Dr;
    return function(r2, o2) {
      const i3 = r2.mul(o2, At), s2 = r2.pow(i3, e2), c4 = r2.mul(o2, s2), a2 = r2.mul(r2.mul(c4, At), s2), u3 = r2.mul(c4, r2.sub(a2, r2.ONE));
...
function ac(t2, e2) {
  const n3 = new Array(e2.length), r2 = e2.reduce((i3, s2, c4) => t2.is0(s2) ? i3 : (n3[c4] = i3, t2.mul(i3, s2)), t2.ONE), o2 = t2.inv(r2);
  return e2.reduceRight((i3, s2, c4) => t2.is0(s2) ? i3 : (n3[c4] = t2.mul(i3, n3[c4]), t2.mul(i3, s2)), o2), n3;
}
function qr(t2, e2) {
...
function Kr2(t2, e2, n3 = false, r2 = {}) {
  ...
  let s2;
  const c4 = Object.freeze({ ORDER: t2, isLE: n3, BITS: o2, BYTES: i3, MASK: Je(o2), ZERO: q, ONE: H, create: (a2) => X(a2, t2), isValid: (a2) => {
    if (typeof a2 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a2);
    return q <= a2 && a2 < t2;
  }, is0: (a2) => a2 === q, isOdd: (a2) => (a2 & H) === H, neg: (a2) => X(-a2, t2), eql: (a2, u3) => a2 === u3, sqr: (a2) => X(a2 * a2, t2), add: (a2, u3) => X(a2 + u3, t2), sub: (a2, u3) => X(a2 - u3, t2), mul: (a2, u3) => X(a2 * u3, t2), pow: (a2, u3) => cc(c4, a2, u3), div: (a2, u3) => X(a2 * nn(u3, t2), t2), sqrN: (a2) => a2 * a2, addN: (a2, u3) => a2 + u3, subN: (a2, u3) => a2 - u3, mulN: (a2, u3) => a2 * u3, inv: (a2) => nn(a2, t2), sqrt: r2.sqrt || ((a2) => (s2 || (s2 = oc(t2)), s2(c4, a2))), invertBatch: (a2) => ac(c4, a2), cmov: (a2, u3, l5) => l5 ? u3 : a2, toBytes: (a2) => n3 ? be(a2, i3) : Mt(a2, i3), fromBytes: (a2) => {
...
function uc(t2, e2, n3 = false) {
  ...
  const s2 = n3 ? ee(t2) : Ot(t2), c4 = X(s2, e2 - H) + H;
  return n3 ? be(c4, o2) : Mt(c4, o2);
}
var Zr = BigInt(0);
var ve = BigInt(1);
function rn(t2, e2) {
...
function dc(t2, e2) {
  return { constTimeNegate: rn, hasPrecomputes(n3) {
    ...
    for (let u3 = 0; u3 < o2; u3++) {
      a2 = c4, s2.push(a2);
      for (let l5 = 1; l5 < i3; l5++) a2 = a2.add(c4), s2.push(a2);
      c4 = a2.double();
    }
    return s2;
  }, wNAF(n3, r2, o2) {
    ...
    const u3 = BigInt(2 ** n3 - 1), l5 = 2 ** n3, f7 = BigInt(n3);
    for (let h4 = 0; h4 < i3; h4++) {
      const y6 = h4 * s2;
      let E4 = Number(o2 & u3);
      o2 >>= f7, E4 > s2 && (E4 -= l5, o2 += ve);
      const p3 = y6, d2 = y6 + Math.abs(E4) - 1, v3 = h4 % 2 !== 0, m2 = E4 < 0;
      E4 === 0 ? a2 = a2.add(rn(v3, r2[p3])) : c4 = c4.add(rn(m2, r2[d2]));
    }
    return { p: c4, f: a2 };
  }, wNAFUnsafe(n3, r2, o2, i3 = t2.ZERO) {
    const { windows: s2, windowSize: c4 } = on(n3, e2), a2 = BigInt(2 ** n3 - 1), u3 = 2 ** n3, l5 = BigInt(n3);
    for (let f7 = 0; f7 < s2; f7++) {
      const h4 = f7 * c4;
      if (o2 === Zr) break;
      let y6 = Number(o2 & a2);
      if (o2 >>= l5, y6 > c4 && (y6 -= u3, o2 += ve), y6 === 0) continue;
      let E4 = r2[h4 + Math.abs(y6) - 1];
      y6 < 0 && (E4 = E4.negate()), i3 = i3.add(E4);
    }
    return i3;
...
function hc(t2, e2, n3, r2) {
  ...
  const o2 = t2.ZERO, i3 = Pr(BigInt(n3.length)), s2 = i3 > 12 ? i3 - 3 : i3 > 4 ? i3 - 2 : i3 ? 2 : 1, c4 = (1 << s2) - 1, a2 = new Array(c4 + 1).fill(o2), u3 = Math.floor((e2.BITS - 1) / s2) * s2;
  let l5 = o2;
  for (let f7 = u3; f7 >= 0; f7 -= s2) {
    a2.fill(o2);
    for (let y6 = 0; y6 < r2.length; y6++) {
      const E4 = r2[y6], p3 = Number(E4 >> BigInt(f7) & BigInt(c4));
      a2[p3] = a2[p3].add(n3[y6]);
    }
    let h4 = o2;
    for (let y6 = a2.length - 1, E4 = o2; y6 > 0; y6--) E4 = E4.add(a2[y6]), h4 = h4.add(E4);
    if (l5 = l5.add(h4), f7 !== 0) for (let y6 = 0; y6 < s2; y6++) l5 = l5.double();
  }
  return l5;
}
function Wr(t2) {
...
function gc(t2) {
  const e2 = pc(t2), { P: n3 } = e2, r2 = (m2) => X(m2, n3), o2 = e2.montgomeryBits, i3 = Math.ceil(o2 / 8), s2 = e2.nByteLength, c4 = e2.adjustScalarBytes || ((m2) => m2), a2 = e2.powPminus2 || ((m2) => Hr(m2, n3 - BigInt(2), n3));
  function u3(m2, O4, N2) {
    const $2 = r2(m2 * (O4 - N2));
    return O4 = r2(O4 - $2), N2 = r2(N2 + $2), [O4, N2];
  }
  const l5 = (e2.a - BigInt(2)) / BigInt(4);
  function f7(m2, O4) {
    ...
    for (let j2 = BigInt(o2 - 1); j2 >= Ht; j2--) {
      ...
      const w2 = B3 + A3, b2 = r2(w2 * w2), I2 = B3 - A3, R3 = r2(I2 * I2), x2 = b2 - R3, C4 = T + S3, P3 = T - S3, k4 = r2(P3 * w2), M3 = r2(C4 * I2), D2 = k4 + M3, z3 = k4 - M3;
      T = r2(D2 * D2), S3 = r2($2 * r2(z3 * z3)), B3 = r2(b2 * R3), A3 = r2(x2 * (b2 + r2(l5 * x2)));
    }
  ...
  function E4(m2) {
    const O4 = et("scalar", m2), N2 = O4.length;
    if (N2 !== i3 && N2 !== s2) {
      let $2 = "" + i3 + " or " + s2;
  ...
  function p3(m2, O4) {
    const N2 = y6(O4), $2 = E4(m2), B3 = f7(N2, $2);
  ...
  return { scalarMult: p3, scalarMultBase: v3, getSharedSecret: (m2, O4) => p3(m2, O4), getPublicKey: (m2) => v3(m2), utils: { randomPrivateKey: () => e2.randomBytes(e2.nByteLength) }, GuBytes: d2 };
}
...
BigInt(8);
function bc(t2) {
  const e2 = BigInt(10), n3 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i3 = un, c4 = t2 * t2 % i3 * t2 % i3, a2 = it(c4, Xr, i3) * c4 % i3, u3 = it(a2, yc, i3) * t2 % i3, l5 = it(u3, wc, i3) * u3 % i3, f7 = it(l5, e2, i3) * l5 % i3, h4 = it(f7, n3, i3) * f7 % i3, y6 = it(h4, r2, i3) * h4 % i3, E4 = it(y6, o2, i3) * y6 % i3, p3 = it(E4, o2, i3) * y6 % i3, d2 = it(p3, e2, i3) * l5 % i3;
  return { pow_p_5_8: it(d2, Xr, i3) * t2 % i3, b2: c4 };
}
function Ec(t2) {
...
var lt = { Err: Oc, _tlv: { encode: (t2, e2) => {
  ...
  const { v: c4, l: a2 } = r2.decode(2, i3), { v: u3, l: l5 } = r2.decode(2, a2);
  if (l5.length) throw new e2("invalid signature: left bytes after parsing");
  return { r: n3.decode(c4), s: n3.decode(u3) };
}, hexFromSig(t2) {
...
function Ac(t2) {
  ...
  function s2(p3) {
    const { a: d2, b: v3 } = e2, m2 = n3.sqr(p3), O4 = n3.mul(m2, p3);
    return n3.add(n3.add(O4, n3.mul(p3, d2)), v3);
  }
  ...
  function a2(p3) {
    const { allowedPrivateKeyLengths: d2, nByteLength: v3, wrapPrivateKey: m2, n: O4 } = e2;
    ...
    let N2;
    try {
      N2 = typeof p3 == "bigint" ? p3 : Ot(et("private key", p3, v3));
    } catch {
      throw new Error("invalid private key, expected hex or " + v3 + " bytes, got " + typeof p3);
    }
    return m2 && (N2 = X(N2, O4)), ft("private key", N2, K2, O4), N2;
  }
  function u3(p3) {
    if (!(p3 instanceof h4)) throw new Error("ProjectivePoint expected");
  }
  const l5 = tn((p3, d2) => {
    const { px: v3, py: m2, pz: O4 } = p3;
    if (n3.eql(O4, n3.ONE)) return { x: v3, y: m2 };
    const N2 = p3.is0();
    d2 == null && (d2 = N2 ? n3.ONE : n3.inv(O4));
    const $2 = n3.mul(v3, d2), B3 = n3.mul(m2, d2), A3 = n3.mul(O4, d2);
  ...
  class h4 {
    ...
    static fromAffine(d2) {
      ...
      return O4(v3) && O4(m2) ? h4.ZERO : new h4(v3, m2, n3.ONE);
    }
    get x() {
    ...
    static normalizeZ(d2) {
      ...
      return d2.map((m2, O4) => m2.toAffine(v3[O4])).map(h4.fromAffine);
    }
    static fromHex(d2) {
    ...
    equals(d2) {
      u3(d2);
      const { px: v3, py: m2, pz: O4 } = this, { px: N2, py: $2, pz: B3 } = d2, A3 = n3.eql(n3.mul(v3, B3), n3.mul(N2, O4)), T = n3.eql(n3.mul(m2, B3), n3.mul($2, O4));
      return A3 && T;
    }
    negate() {
    ...
    double() {
      const { a: d2, b: v3 } = e2, m2 = n3.mul(v3, Qr), { px: O4, py: N2, pz: $2 } = this;
      let B3 = n3.ZERO, A3 = n3.ZERO, T = n3.ZERO, S3 = n3.mul(O4, O4), L2 = n3.mul(N2, N2), U4 = n3.mul($2, $2), _2 = n3.mul(O4, N2);
      return _2 = n3.add(_2, _2), T = n3.mul(O4, $2), T = n3.add(T, T), B3 = n3.mul(d2, T), A3 = n3.mul(m2, U4), A3 = n3.add(B3, A3), B3 = n3.sub(L2, A3), A3 = n3.add(L2, A3), A3 = n3.mul(B3, A3), B3 = n3.mul(_2, B3), T = n3.mul(m2, T), U4 = n3.mul(d2, U4), _2 = n3.sub(S3, U4), _2 = n3.mul(d2, _2), _2 = n3.add(_2, T), T = n3.add(S3, S3), S3 = n3.add(T, S3), S3 = n3.add(S3, U4), S3 = n3.mul(S3, _2), A3 = n3.add(A3, S3), U4 = n3.mul(N2, $2), U4 = n3.add(U4, U4), S3 = n3.mul(U4, _2), B3 = n3.sub(B3, S3), T = n3.mul(U4, L2), T = n3.add(T, T), T = n3.add(T, T), new h4(B3, A3, T);
    }
    add(d2) {
      u3(d2);
      const { px: v3, py: m2, pz: O4 } = this, { px: N2, py: $2, pz: B3 } = d2;
      let A3 = n3.ZERO, T = n3.ZERO, S3 = n3.ZERO;
      const L2 = e2.a, U4 = n3.mul(e2.b, Qr);
      let _2 = n3.mul(v3, N2), j2 = n3.mul(m2, $2), g = n3.mul(O4, B3), w2 = n3.add(v3, m2), b2 = n3.add(N2, $2);
      w2 = n3.mul(w2, b2), b2 = n3.add(_2, j2), w2 = n3.sub(w2, b2), b2 = n3.add(v3, O4);
      let I2 = n3.add(N2, B3);
      return b2 = n3.mul(b2, I2), I2 = n3.add(_2, g), b2 = n3.sub(b2, I2), I2 = n3.add(m2, O4), A3 = n3.add($2, B3), I2 = n3.mul(I2, A3), A3 = n3.add(j2, g), I2 = n3.sub(I2, A3), S3 = n3.mul(L2, b2), A3 = n3.mul(U4, g), S3 = n3.add(A3, S3), A3 = n3.sub(j2, S3), S3 = n3.add(j2, S3), T = n3.mul(A3, S3), j2 = n3.add(_2, _2), j2 = n3.add(j2, _2), g = n3.mul(L2, g), b2 = n3.mul(U4, b2), j2 = n3.add(j2, g), g = n3.sub(_2, g), g = n3.mul(L2, g), b2 = n3.add(b2, g), _2 = n3.mul(j2, b2), T = n3.add(T, _2), _2 = n3.mul(I2, b2), A3 = n3.mul(w2, A3), A3 = n3.sub(A3, _2), _2 = n3.mul(w2, j2), S3 = n3.mul(I2, S3), S3 = n3.add(S3, _2), new h4(A3, T, S3);
    }
    subtract(d2) {
    ...
    wNAF(d2) {
      return E4.wNAFCached(this, d2, h4.normalizeZ);
    }
    multiplyUnsafe(d2) {
      ...
      if (!v3 || E4.hasPrecomputes(this)) return E4.wNAFCachedUnsafe(this, d2, h4.normalizeZ);
      let { k1neg: N2, k1: $2, k2neg: B3, k2: A3 } = v3.splitScalar(d2), T = O4, S3 = O4, L2 = this;
      for (; $2 > dt || A3 > dt; ) $2 & K2 && (T = T.add(L2)), A3 & K2 && (S3 = S3.add(L2)), L2 = L2.double(), $2 >>= K2, A3 >>= K2;
      return N2 && (T = T.negate()), B3 && (S3 = S3.negate()), S3 = new h4(n3.mul(S3.px, v3.beta), S3.py, S3.pz), T.add(S3);
    }
    multiply(d2) {
      const { endo: v3, n: m2 } = e2;
      ft("scalar", d2, K2, m2);
      ...
      if (v3) {
        ...
        let { p: S3, f: L2 } = this.wNAF(B3), { p: U4, f: _2 } = this.wNAF(T);
        S3 = E4.constTimeNegate($2, S3), U4 = E4.constTimeNegate(A3, U4), U4 = new h4(n3.mul(U4.px, v3.beta), U4.py, U4.pz), O4 = S3.add(U4), N2 = L2.add(_2);
      } else {
    ...
    multiplyAndAddUnsafe(d2, v3, m2) {
      const O4 = h4.BASE, N2 = (B3, A3) => A3 === dt || A3 === K2 || !B3.equals(O4) ? B3.multiplyUnsafe(A3) : B3.multiply(A3), $2 = N2(this, v3).add(N2(d2, m2));
  ...
  const y6 = e2.nBitLength, E4 = dc(h4, e2.endo ? Math.ceil(y6 / 2) : y6);
  return { CURVE: e2, ProjectivePoint: h4, normPrivateKeyToScalar: a2, weierstrassEquation: s2, isWithinCurveOrder: c4 };
}
function Bc(t2) {
  const e2 = Wr(t2);
...
function Ic(t2) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u3, weierstrassEquation: l5, isWithinCurveOrder: f7 } = Ac({ ...e2, toBytes(g, w2, b2) {
    const I2 = w2.toAffine(), R3 = n3.toBytes(I2.x), x2 = ne;
    return Ct("isCompressed", b2), b2 ? x2(Uint8Array.from([w2.hasEvenY() ? 2 : 3]), R3) : x2(Uint8Array.from([4]), R3, n3.toBytes(I2.y));
  }, fromBytes(g) {
    const w2 = g.length, b2 = g[0], I2 = g.subarray(1);
    if (w2 === o2 && (b2 === 2 || b2 === 3)) {
      const R3 = Ot(I2);
      if (!Ee(R3, K2, n3.ORDER)) throw new Error("Point is not on curve");
      const x2 = l5(R3);
      let C4;
      try {
        C4 = n3.sqrt(x2);
      ...
      const R3 = n3.fromBytes(I2.subarray(0, n3.BYTES)), x2 = n3.fromBytes(I2.subarray(n3.BYTES, 2 * n3.BYTES));
      return { x: R3, y: x2 };
    } else {
      const R3 = o2, x2 = i3;
  ...
  class d2 {
    ...
    recoverPublicKey(w2) {
      const { r: b2, s: I2, recovery: R3 } = this, x2 = B3(et("msgHash", w2));
      ...
      const P3 = (R3 & 1) === 0 ? "02" : "03", k4 = a2.fromHex(P3 + h4(C4)), M3 = c4(C4), D2 = s2(-x2 * M3), z3 = s2(I2 * M3), Z2 = a2.BASE.multiplyAndAddUnsafe(k4, D2, z3);
  ...
  function S3(g, w2, b2 = L2) {
    ...
    let { lowS: x2, prehash: C4, extraEntropy: P3 } = b2;
    x2 == null && (x2 = true), g = et("msgHash", g), Jr(b2), C4 && (g = et("prehashed msgHash", I2(g)));
    const k4 = B3(g), M3 = u3(w2), D2 = [T(M3), T(k4)];
    if (P3 != null && P3 !== false) {
      const W2 = P3 === true ? R3(n3.BYTES) : P3;
      D2.push(et("extraEntropy", W2));
    }
    const z3 = ne(...D2), Z2 = k4;
    function st2(W2) {
      const J2 = $2(W2);
      if (!f7(J2)) return;
      const Be3 = c4(J2), zt2 = a2.BASE.multiply(J2).toAffine(), vt = s2(zt2.x);
      if (vt === dt) return;
      const Zt2 = s2(Be3 * s2(Z2 + vt * M3));
      if (Zt2 === dt) return;
      let Ut2 = (zt2.x === vt ? 0 : 2) | Number(zt2.y & K2), vn2 = Zt2;
      return x2 && y6(Zt2) && (vn2 = E4(Zt2), Ut2 ^= 1), new d2(vt, vn2, Ut2);
    }
    return { seed: z3, k2sig: st2 };
  }
  const L2 = { lowS: e2.lowS, prehash: false }, U4 = { lowS: e2.lowS, prehash: false };
  function _2(g, w2, b2 = L2) {
    const { seed: I2, k2sig: R3 } = S3(g, w2, b2), x2 = e2;
    return Vr(x2.hash.outputLen, x2.nByteLength, x2.hmac)(I2, R3);
  }
  a2.BASE._setWindowSize(8);
  function j2(g, w2, b2, I2 = U4) {
    var _a;
    const R3 = g;
    w2 = et("msgHash", w2), b2 = et("publicKey", b2);
    const { lowS: x2, prehash: C4, format: P3 } = I2;
    ...
    const k4 = typeof R3 == "string" || St(R3), M3 = !k4 && !P3 && typeof R3 == "object" && R3 !== null && typeof R3.r == "bigint" && typeof R3.s == "bigint";
    if (!k4 && !M3) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    let D2, z3;
    try {
      if (M3 && (D2 = new d2(R3.r, R3.s)), k4) {
        try {
          P3 !== "compact" && (D2 = d2.fromDER(R3));
        } catch (Ut2) {
          if (!(Ut2 instanceof lt.Err)) throw Ut2;
        }
        !D2 && P3 !== "der" && (D2 = d2.fromCompact(R3));
      }
      z3 = a2.fromHex(b2);
    } catch {
      return false;
    ...
    C4 && (w2 = e2.hash(w2));
    const { r: Z2, s: st2 } = D2, W2 = B3(w2), J2 = c4(st2), Be3 = s2(W2 * J2), zt2 = s2(Z2 * J2), vt = (_a = a2.BASE.multiplyAndAddUnsafe(z3, Be3, zt2)) == null ? void 0 : _a.toAffine();
    return vt ? s2(vt.x) === Z2 : false;
  }
  return { CURVE: e2, getPublicKey: m2, getSharedSecret: N2, sign: _2, verify: j2, ProjectivePoint: a2, Signature: d2, utils: v3 };
}
function Nc(t2) {
...
function Se(t2) {
  ...
  if (Bt(r2) === Ft) {
    const a2 = o2 + hn, u3 = a2 + oe, l5 = n3.slice(o2, a2), f7 = n3.slice(a2, u3), h4 = n3.slice(u3);
    return { type: r2, sealed: h4, iv: f7, senderPublicKey: l5 };
  }
  if (Bt(r2) === re) {
    const a2 = n3.slice(o2), u3 = Lt(oe);
    return { type: r2, sealed: a2, iv: u3 };
  }
  const i3 = o2 + oe, s2 = n3.slice(o2, i3), c4 = n3.slice(i3);
  return { type: r2, sealed: c4, iv: s2 };
}
function qc(t2, e2) {
  const n3 = Se({ encoded: t2, encoding: e2 == null ? void 0 : e2.encoding });
  return oo({ type: Bt(n3.type), senderPublicKey: typeof n3.senderPublicKey < "u" ? toString(n3.senderPublicKey, G) : void 0, receiverPublicKey: e2 == null ? void 0 : e2.receiverPublicKey });
}
function oo(t2) {
...
function zc(t2, e2) {
  ...
  const s2 = i3.slice(0, 32), c4 = i3.slice(32, 64), a2 = `${n3}.${r2}`, u3 = Qt(a2), l5 = io(e2);
  if (!_c.verify(concat([s2, c4]), u3, l5)) throw new Error("Invalid signature");
...
function Gc(t2) {
  ...
  const e2 = t2.indexOf(":"), n3 = t2.indexOf("?") !== -1 ? t2.indexOf("?") : void 0, r2 = t2.substring(0, e2), o2 = t2.substring(e2 + 1, n3).split("@"), i3 = typeof n3 < "u" ? t2.substring(n3) : "", s2 = new URLSearchParams(i3), c4 = {};
  s2.forEach((u3, l5) => {
    c4[l5] = u3;
  });
...
function rr2(r2, e2) {
  ...
  var a2 = r2.length, c4 = r2.charAt(0), h4 = Math.log(a2) / Math.log(256), l5 = Math.log(256) / Math.log(a2);
  function d2(u3) {
    ...
    for (var b2 = 0, x2 = 0, I2 = 0, D2 = u3.length; I2 !== D2 && u3[I2] === 0; ) I2++, b2++;
    for (var j2 = (D2 - I2) * l5 + 1 >>> 0, T = new Uint8Array(j2); I2 !== D2; ) {
      for (var q3 = u3[I2], J2 = 0, K4 = j2 - 1; (q3 !== 0 || J2 < x2) && K4 !== -1; K4--, J2++) q3 += 256 * T[K4] >>> 0, T[K4] = q3 % a2 >>> 0, q3 = q3 / a2 >>> 0;
      if (q3 !== 0) throw new Error("Non-zero carry");
      x2 = J2, I2++;
    }
    for (var H3 = j2 - x2; H3 !== j2 && T[H3] === 0; ) H3++;
    for (var me3 = c4.repeat(b2); H3 < j2; ++H3) me3 += r2.charAt(T[H3]);
    return me3;
  }
  function g(u3) {
    ...
    var b2 = 0;
    if (u3[b2] !== " ") {
      for (var x2 = 0, I2 = 0; u3[b2] === c4; ) x2++, b2++;
      for (var D2 = (u3.length - b2) * h4 + 1 >>> 0, j2 = new Uint8Array(D2); u3[b2]; ) {
        var T = t2[u3.charCodeAt(b2)];
        if (T === 255) return;
        for (var q3 = 0, J2 = D2 - 1; (T !== 0 || q3 < I2) && J2 !== -1; J2--, q3++) T += a2 * j2[J2] >>> 0, j2[J2] = T % 256 >>> 0, T = T / 256 >>> 0;
        if (T !== 0) throw new Error("Non-zero carry");
        I2 = q3, b2++;
      }
      if (u3[b2] !== " ") {
        for (var K4 = D2 - I2; K4 !== D2 && j2[K4] === 0; ) K4++;
        for (var H3 = new Uint8Array(x2 + (D2 - K4)), me3 = x2; K4 !== D2; ) H3[me3++] = j2[K4++];
        return H3;
      }
    }
  }
...
var gr = (r2, e2, t2, i3) => {
  const s2 = {};
  for (let l5 = 0; l5 < e2.length; ++l5) s2[e2[l5]] = l5;
  let n3 = r2.length;
  for (; r2[n3 - 1] === "="; ) --n3;
...
var pr = (r2, e2, t2) => {
  ...
  let n3 = "", o2 = 0, a2 = 0;
  for (let c4 = 0; c4 < r2.length; ++c4) for (a2 = a2 << 8 | r2[c4], o2 += 8; o2 > t2; ) o2 -= t2, n3 += e2[s2 & a2 >> o2];
...
var vi2 = class {
  constructor(e2, t2, i3) {
    this.core = e2, this.logger = t2, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      this.isInitialized();
      const n3 = await this.getClientSeed(), o2 = Po(n3), a2 = this.randomSessionIdentifier, c4 = Ct2;
      return await Qo(a2, s2, c4, o2);
    }), S2(this, "generateSharedKey", (s2, n3, o2) => {
      this.isInitialized();
      const a2 = this.getPrivateKey(s2), c4 = Cc(a2, n3);
      ...
      this.isInitialized();
      const a2 = oo(o2), c4 = safeJsonStringify(n3);
      if (Fc(a2)) return Dc(c4, o2 == null ? void 0 : o2.encoding);
      if (Kc(a2)) {
        const g = a2.senderPublicKey, _2 = a2.receiverPublicKey;
        s2 = await this.generateSharedKey(g, _2);
      }
      const h4 = this.getSymKey(s2), { type: l5, senderPublicKey: d2 } = a2;
      return Vc({ type: l5, symKey: h4, message: c4, senderPublicKey: d2, encoding: o2 == null ? void 0 : o2.encoding });
    }), S2(this, "decode", async (s2, n3, o2) => {
      this.isInitialized();
      const a2 = qc(n3, o2);
      if (Fc(a2)) {
        const c4 = Hc(n3, o2 == null ? void 0 : o2.encoding);
        return safeJsonParse(c4);
      }
      if (Kc(a2)) {
        const c4 = a2.receiverPublicKey, h4 = a2.senderPublicKey;
        s2 = await this.generateSharedKey(c4, h4);
      }
      try {
        const c4 = this.getSymKey(s2), h4 = Mc({ symKey: c4, encoded: n3, encoding: o2 == null ? void 0 : o2.encoding });
...
var k3 = (r2, e2, t2) => Ve(r2, typeof e2 != "symbol" ? e2 + "" : e2, t2);
var _i2 = class extends y4 {
  constructor(e2, t2) {
    super(e2, t2), this.logger = e2, this.core = t2, k3(this, "messages", /* @__PURE__ */ new Map()), k3(this, "messagesWithoutClientAck", /* @__PURE__ */ new Map()), k3(this, "name", Ot2), k3(this, "version", Rt2), k3(this, "initialized", false), k3(this, "storagePrefix", B), k3(this, "init", async () => {
      ...
      if (a2[o2] = s2, this.messages.set(i3, a2), n3 === le2.inbound) {
        ...
        this.messagesWithoutClientAck.set(i3, Un(jn2({}, c4), { [o2]: s2 }));
      }
...
var qn = class extends m {
  constructor(e2, t2) {
    super(e2, t2), this.relayer = e2, this.logger = t2, V2(this, "events", new import_events3.EventEmitter()), V2(this, "name", At2), V2(this, "queue", /* @__PURE__ */ new Map()), V2(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V2(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V2(this, "needsTransportRestart", false), V2(this, "publish", async (i3, s2, n3) => {
      ...
      const a2 = (n3 == null ? void 0 : n3.ttl) || je2, c4 = Zc(n3), h4 = (n3 == null ? void 0 : n3.prompt) || false, l5 = (n3 == null ? void 0 : n3.tag) || 0, d2 = (n3 == null ? void 0 : n3.id) || getBigIntRpcId().toString(), g = { topic: i3, message: s2, opts: { ttl: a2, relay: c4, prompt: h4, tag: l5, id: d2, attestation: n3 == null ? void 0 : n3.attestation, tvf: n3 == null ? void 0 : n3.tvf } }, _2 = `Failed to publish payload, please try again. id:${d2} tag:${l5}`;
      try {
        const u3 = new Promise(async (b2) => {
          const x2 = ({ id: D2 }) => {
            g.opts.id === D2 && (this.removeRequestFromQueue(D2), this.relayer.events.removeListener(C2.publish, x2), b2(g));
          };
          this.relayer.events.on(C2.publish, x2);
          const I2 = yi(new Promise((D2, j2) => {
            this.rpcPublish({ topic: i3, message: s2, ttl: a2, prompt: h4, tag: l5, id: d2, attestation: n3 == null ? void 0 : n3.attestation, tvf: n3 == null ? void 0 : n3.tvf }).then(D2).catch((T) => {
              this.logger.warn(T, T == null ? void 0 : T.message), j2(T);
            });
          }), this.initialPublishTimeout, `Failed initial publish, retrying.... id:${d2} tag:${l5}`);
          try {
            await I2, this.events.removeListener(C2.publish, x2);
          } catch (D2) {
            this.queue.set(d2, Ge2(Ie2({}, g), { attempt: 1 })), this.logger.warn(D2, D2 == null ? void 0 : D2.message);
          }
        });
        this.logger.trace({ type: "method", method: "publish", params: { id: d2, topic: i3, message: s2, opts: n3 } }), await yi(u3, this.publishTimeout, _2);
      } catch (u3) {
  ...
  async rpcPublish(e2) {
    var t2, i3, s2, n3;
    const { topic: o2, message: a2, ttl: c4 = je2, prompt: h4, tag: l5, id: d2, attestation: g, tvf: _2 } = e2, u3 = { method: Yc(Zc().protocol).publish, params: Ie2({ topic: o2, message: a2, ttl: c4, prompt: h4, tag: l5, attestation: g }, _2), id: d2 };
...
var Ti2 = class extends P {
  constructor(e2, t2) {
    super(e2, t2), this.relayer = e2, this.logger = t2, f5(this, "subscriptions", /* @__PURE__ */ new Map()), f5(this, "topicMap", new Hn()), f5(this, "events", new import_events3.EventEmitter()), f5(this, "name", Ut), f5(this, "version", Ft2), f5(this, "pending", /* @__PURE__ */ new Map()), f5(this, "cached", []), f5(this, "initialized", false), f5(this, "storagePrefix", B), f5(this, "subscribeTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), f5(this, "initialSubscribeTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), f5(this, "clientId"), f5(this, "batchSubscribeTopicsLimit", 500), f5(this, "init", async () => {
      ...
      try {
        const n3 = Zc(s2), o2 = { topic: i3, relay: n3, transportType: s2 == null ? void 0 : s2.transportType };
  ...
  async rpcSubscribe(e2, t2, i3) {
    var s2;
    (!i3 || (i3 == null ? void 0 : i3.transportType) === Q.relay) && await this.restartToComplete({ topic: e2, id: e2, relay: t2 });
    ...
    const o2 = (s2 = i3 == null ? void 0 : i3.internal) == null ? void 0 : s2.throwOnFailedPublish;
    try {
      const a2 = await this.getSubscriptionId(e2);
      if ((i3 == null ? void 0 : i3.transportType) === Q.link_mode) return setTimeout(() => {
        (this.relayer.connected || this.relayer.connecting) && this.relayer.request(n3).catch((l5) => this.logger.warn(l5));
      }, (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND)), a2;
      const c4 = new Promise(async (l5) => {
        const d2 = (g) => {
          g.topic === e2 && (this.events.removeListener($.created, d2), l5(g.id));
        };
        this.events.on($.created, d2);
        try {
          const g = await yi(new Promise((_2, u3) => {
            this.relayer.request(n3).catch((b2) => {
              this.logger.warn(b2, b2 == null ? void 0 : b2.message), u3(b2);
            }).then(_2);
          }), this.initialSubscribeTimeout, `Subscribing to ${e2} failed, please try again`);
          this.events.removeListener($.created, d2), l5(g);
        } catch {
        }
      }), h4 = await yi(c4, this.subscribeTimeout, `Subscribing to ${e2} failed, please try again`);
...
var y5 = (r2, e2, t2) => Ye2(r2, typeof e2 != "symbol" ? e2 + "" : e2, t2);
var Si = class extends d {
  constructor(e2) {
    super(e2), y5(this, "protocol", "wc"), y5(this, "version", 2), y5(this, "core"), y5(this, "logger"), y5(this, "events", new import_events3.EventEmitter()), y5(this, "provider"), y5(this, "messages"), y5(this, "subscriber"), y5(this, "publisher"), y5(this, "name", $t2), y5(this, "transportExplicitlyClosed", false), y5(this, "initialized", false), y5(this, "connectionAttemptInProgress", false), y5(this, "relayUrl"), y5(this, "projectId"), y5(this, "packageName"), y5(this, "bundleId"), y5(this, "hasExperiencedNetworkDisruption", false), y5(this, "pingTimeout"), y5(this, "heartBeatTimeout", (0, import_time2.toMiliseconds)(import_time2.THIRTY_SECONDS + import_time2.FIVE_SECONDS)), y5(this, "reconnectTimeout"), y5(this, "connectPromise"), y5(this, "reconnectInProgress", false), y5(this, "requestsInFlight", []), y5(this, "connectTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), y5(this, "request", async (t2) => {
      var i3, s2;
  ...
  async subscribe(e2, t2) {
    ...
    const o2 = typeof ((i3 = t2 == null ? void 0 : t2.internal) == null ? void 0 : i3.throwOnFailedPublish) > "u" ? true : (s2 = t2 == null ? void 0 : t2.internal) == null ? void 0 : s2.throwOnFailedPublish;
    let a2 = ((n3 = this.subscriber.topicMap.get(e2)) == null ? void 0 : n3[0]) || "", c4;
    const h4 = (l5) => {
      l5.topic === e2 && (this.subscriber.off($.created, h4), c4());
    };
    return await Promise.all([new Promise((l5) => {
      c4 = l5, this.subscriber.on($.created, h4);
    }), new Promise(async (l5, d2) => {
  ...
  async registerEventListeners() {
    let e2 = await Na();
    Ua(async (t2) => {
      e2 !== t2 && (e2 = t2, t2 ? await this.transportOpen().catch((i3) => this.logger.error(i3, i3 == null ? void 0 : i3.message)) : (this.hasExperiencedNetworkDisruption = true, await this.transportDisconnect(), this.transportExplicitlyClosed = false));
...
function ye2(r2, e2, t2, i3) {
  ...
  switch (s2) {
    ...
    case oo2: {
      const c4 = r2.valueOf(), h4 = e2.valueOf();
      return Oo(c4, h4);
    }
    case ao2:
    case ho:
  ...
  try {
    switch (s2) {
      case lo: {
        ...
        for (const [c4, h4] of r2.entries()) if (!e2.has(c4) || !pe(h4, e2.get(c4), c4, r2, e2, t2, i3)) return false;
        return true;
      }
      case uo2: {
        if (r2.size !== e2.size) return false;
        const c4 = Array.from(r2.values()), h4 = Array.from(e2.values());
        for (let l5 = 0; l5 < c4.length; l5++) {
          const d2 = c4[l5], g = h4.findIndex((_2) => pe(d2, _2, void 0, r2, e2, t2, i3));
          if (g === -1) return false;
          h4.splice(g, 1);
        }
        return true;
      ...
      case So: {
        ...
        for (let c4 = 0; c4 < r2.length; c4++) if (!pe(r2[c4], e2[c4], c4, r2, e2, t2, i3)) return false;
        return true;
      }
      case yo:
      ...
      case Je2: {
        ...
        const h4 = [...Object.keys(r2), ...Ri2(r2)], l5 = [...Object.keys(e2), ...Ri2(e2)];
        if (h4.length !== l5.length) return false;
        for (let d2 = 0; d2 < h4.length; d2++) {
          const g = h4[d2], _2 = r2[g];
          if (!Object.hasOwn(e2, g)) return false;
          const u3 = e2[g];
          if (!pe(_2, u3, g, r2, e2, t2, i3)) return false;
        }
        return true;
      }
      default:
...
var z2 = (r2, e2, t2) => Xe2(r2, typeof e2 != "symbol" ? e2 + "" : e2, t2);
var zi2 = class extends f3 {
  constructor(e2, t2, i3, s2 = B, n3 = void 0) {
    super(e2, t2, i3, s2), this.core = e2, this.logger = t2, this.name = i3, z2(this, "map", /* @__PURE__ */ new Map()), z2(this, "version", kt2), z2(this, "cached", []), z2(this, "initialized", false), z2(this, "getKey"), z2(this, "storagePrefix", B), z2(this, "recentlyDeleted", []), z2(this, "recentlyDeletedLimit", 200), z2(this, "init", async () => {
    ...
    }), z2(this, "get", (o2) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: o2 }), this.getData(o2))), z2(this, "getAll", (o2) => (this.isInitialized(), o2 ? this.values.filter((a2) => Object.keys(o2).every((c4) => Ao(a2[c4], o2[c4]))) : this.values)), z2(this, "update", async (o2, a2) => {
...
var Li2 = class {
  constructor(e2, t2) {
    this.core = e2, this.logger = t2, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      this.isInitialized();
      const s2 = jc(), n3 = await this.core.crypto.setSymKey(s2), o2 = Ei(import_time2.FIVE_MINUTES), a2 = { protocol: xt2 }, c4 = { topic: n3, expiry: o2, relay: a2, active: false, methods: i3 == null ? void 0 : i3.methods }, h4 = Wc({ protocol: this.core.protocol, version: this.core.version, topic: n3, symKey: s2, relay: a2, expiryTimestamp: o2, methods: i3 == null ? void 0 : i3.methods });
      return this.events.emit(re2.create, c4), this.core.expirer.set(n3, o2), await this.pairings.set(n3, c4), await this.core.relayer.subscribe(n3, { transportType: i3 == null ? void 0 : i3.transportType }), { topic: n3, uri: h4 };
      ...
      const { topic: n3, symKey: o2, relay: a2, expiryTimestamp: c4, methods: h4 } = Gc(i3.uri);
      ...
      if (this.pairings.keys.includes(n3)) {
        if (l5 = this.pairings.get(n3), s2.addTrace(G2.existing_pairing), l5.active) throw s2.setError(Y2.active_pairing_already_exists), new Error(`Pairing already exists: ${n3}. Please try again with a new connection URI.`);
        s2.addTrace(G2.pairing_not_expired);
      }
      const d2 = c4 || Ei(import_time2.FIVE_MINUTES), g = { topic: n3, relay: a2, expiry: d2, active: false, methods: h4 };
      ...
      try {
        ...
        throw s2.setError(Y2.subscribe_pairing_topic_failure), _2;
      }
      ...
      if (this.pairings.keys.includes(s2)) {
        const n3 = await this.sendRequest(s2, "wc_pairingPing", {}), { done: o2, resolve: a2, reject: c4 } = gi();
      ...
      this.isInitialized();
      const { topic: s2, relay: n3, expiry: o2, methods: a2 } = i3, c4 = this.core.crypto.keychain.get(s2);
      return Wc({ protocol: this.core.protocol, version: this.core.version, topic: s2, symKey: c4, relay: n3, expiryTimestamp: o2, methods: a2 });
    }), p2(this, "sendRequest", async (i3, s2, n3) => {
      const o2 = formatJsonRpcRequest(s2, n3), a2 = await this.core.crypto.encode(i3, o2), c4 = se[s2].req;
      return this.core.history.set(i3, o2), this.core.relayer.publish(i3, a2, c4), o2.id;
    }), p2(this, "sendResult", async (i3, s2, n3) => {
      const o2 = formatJsonRpcResult(i3, n3), a2 = await this.core.crypto.encode(s2, o2), c4 = (await this.core.history.get(s2, i3)).request.method, h4 = se[c4].res;
      await this.core.relayer.publish(s2, a2, h4), await this.core.history.resolve(o2);
    }), p2(this, "sendError", async (i3, s2, n3) => {
      const o2 = formatJsonRpcError(i3, n3), a2 = await this.core.crypto.encode(s2, o2), c4 = (await this.core.history.get(s2, i3)).request.method, h4 = se[c4] ? se[c4].res : se.unregistered_method.res;
      await this.core.relayer.publish(s2, a2, h4), await this.core.history.resolve(o2);
...
var O3 = (r2, e2, t2) => jo(r2, typeof e2 != "symbol" ? e2 + "" : e2, t2);
var ki2 = class extends I {
  constructor(e2, t2) {
    super(e2, t2), this.core = e2, this.logger = t2, O3(this, "records", /* @__PURE__ */ new Map()), O3(this, "events", new import_events3.EventEmitter()), O3(this, "name", Bt2), O3(this, "version", Vt2), O3(this, "cached", []), O3(this, "initialized", false), O3(this, "storagePrefix", B), O3(this, "init", async () => {
    ...
    }), O3(this, "get", async (i3, s2) => (this.isInitialized(), this.logger.debug("Getting record"), this.logger.trace({ type: "method", method: "get", topic: i3, id: s2 }), await this.getRecord(s2))), O3(this, "delete", (i3, s2) => {
    ...
    }), O3(this, "exists", async (i3, s2) => (this.isInitialized(), this.records.has(s2) ? (await this.getRecord(s2)).topic === i3 : false)), O3(this, "on", (i3, s2) => {
      this.events.on(i3, s2);
    }), O3(this, "once", (i3, s2) => {
      this.events.once(i3, s2);
    }), O3(this, "off", (i3, s2) => {
      this.events.off(i3, s2);
    }), O3(this, "removeListener", (i3, s2) => {
      this.events.removeListener(i3, s2);
...
var Ui2 = class extends M {
  constructor(e2, t2, i3) {
    super(e2, t2, i3), this.core = e2, this.logger = t2, this.store = i3, w(this, "name", Wt2), w(this, "abortController"), w(this, "isDevEnv"), w(this, "verifyUrlV3", Yt2), w(this, "storagePrefix", B), w(this, "version", Le), w(this, "publicKey"), w(this, "fetchPromise"), w(this, "init", async () => {
      ...
      const n3 = window.location.origin, { id: o2, decryptedId: a2 } = s2, c4 = `${this.verifyUrlV3}/attestation?projectId=${this.core.projectId}&origin=${n3}&id=${o2}&decryptedId=${a2}`;
      try {
        const h4 = (0, import_window_getters2.getDocument)(), l5 = this.startAbortTimer(import_time2.ONE_SECOND * 5), d2 = await new Promise((g, _2) => {
          const u3 = () => {
            window.removeEventListener("message", x2), h4.body.removeChild(b2), _2("attestation aborted");
          };
          this.abortController.signal.addEventListener("abort", u3);
          const b2 = h4.createElement("iframe");
          b2.src = c4, b2.style.display = "none", b2.addEventListener("error", u3, { signal: this.abortController.signal });
          const x2 = (I2) => {
            if (I2.data && typeof I2.data == "string") try {
              const D2 = JSON.parse(I2.data);
              if (D2.type === "verify_attestation") {
                if (sn(D2.attestation).payload.id !== o2) return;
                clearInterval(l5), h4.body.removeChild(b2), this.abortController.signal.removeEventListener("abort", u3), window.removeEventListener("message", x2), g(D2.attestation === null ? "" : D2.attestation);
              }
            } catch (D2) {
              this.logger.warn(D2);
            }
...
var Mi2 = class extends O2 {
  constructor(e2, t2) {
    super(e2, t2), this.projectId = e2, this.logger = t2, Fi2(this, "context", Xt2), Fi2(this, "registerDeviceToken", async (i3) => {
      const { clientId: s2, token: n3, notificationType: o2, enableEncrypted: a2 = false } = i3, c4 = `${Zt}/${this.projectId}/clients`;
      await fetch(c4, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ client_id: s2, type: o2, token: n3, always_raw: a2 }) });
...
var E3 = (r2, e2, t2) => Ze2(r2, typeof e2 != "symbol" ? e2 + "" : e2, t2);
var Bi2 = class extends R {
  constructor(e2, t2, i3 = true) {
    super(e2, t2, i3), this.core = e2, this.logger = t2, E3(this, "context", ei2), E3(this, "storagePrefix", B), E3(this, "storageVersion", Qt2), E3(this, "events", /* @__PURE__ */ new Map()), E3(this, "shouldPersist", false), E3(this, "init", async () => {
      if (!Ii()) try {
      ...
      const { event: n3 = "ERROR", type: o2 = "", properties: { topic: a2, trace: c4 } } = s2, h4 = Bi(), l5 = this.core.projectId || "", d2 = Date.now(), g = be2({ eventId: h4, timestamp: d2, props: { event: n3, type: o2, properties: { topic: a2, trace: c4 } }, bundleId: l5, domain: this.getAppDomain() }, this.setMethods(h4));
    ...
    }), E3(this, "setMethods", (s2) => ({ addTrace: (n3) => this.addTrace(s2, n3), setError: (n3) => this.setError(s2, n3) })), E3(this, "addTrace", (s2, n3) => {
      const o2 = this.events.get(s2);
      o2 && (o2.props.properties.trace.push(n3), this.events.set(s2, o2), this.shouldPersist = true);
    }), E3(this, "setError", (s2, n3) => {
      const o2 = this.events.get(s2);
    ...
    }), E3(this, "getAppDomain", () => Pn().url), this.logger = E(t2, this.context), this.telemetryEnabled = i3, i3 ? this.restore().then(async () => {
...
var Te = class _Te extends h3 {
  constructor(e2) {
    ...
    super(e2), v2(this, "protocol", ze2), v2(this, "version", Le), v2(this, "name", he), v2(this, "relayUrl"), v2(this, "projectId"), v2(this, "customStoragePrefix"), v2(this, "events", new import_events3.EventEmitter()), v2(this, "logger"), v2(this, "heartbeat"), v2(this, "relayer"), v2(this, "crypto"), v2(this, "storage"), v2(this, "history"), v2(this, "expirer"), v2(this, "pairing"), v2(this, "verify"), v2(this, "echoClient"), v2(this, "linkModeSupportedApps"), v2(this, "eventClient"), v2(this, "initialized", false), v2(this, "logChunkController"), v2(this, "on", (a2, c4) => this.events.on(a2, c4)), v2(this, "once", (a2, c4) => this.events.once(a2, c4)), v2(this, "off", (a2, c4) => this.events.off(a2, c4)), v2(this, "removeListener", (a2, c4) => this.events.removeListener(a2, c4)), v2(this, "dispatchEnvelope", ({ topic: a2, message: c4, sessionExists: h4 }) => {
      if (!a2 || !c4) return;
      const l5 = { topic: a2, message: c4, publishedAt: Date.now(), transportType: Q.link_mode };
      this.relayer.onLinkMessageEvent(l5, { sessionExists: h4 });
    });
    ...
    const s2 = k({ level: typeof (e2 == null ? void 0 : e2.logger) == "string" && e2.logger ? e2.logger : Et2.logger, name: he }), { logger: n3, chunkLoggerController: o2 } = A({ opts: s2, maxSizeInBytes: e2 == null ? void 0 : e2.maxLogBlobSizeInBytes, loggerOverride: e2 == null ? void 0 : e2.logger });
    ...
    }), this.logger = E(n3, this.name), this.heartbeat = new i(), this.crypto = new vi2(this, this.logger, e2 == null ? void 0 : e2.keychain), this.history = new ki2(this, this.logger), this.expirer = new ji2(this, this.logger), this.storage = e2 != null && e2.storage ? e2.storage : new h2(qi2(qi2({}, It), e2 == null ? void 0 : e2.storageOptions)), this.relayer = new Si({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Li2(this, this.logger), this.verify = new Ui2(this, this.logger, this.storage), this.echoClient = new Mi2(this.projectId || "", this.logger), this.linkModeSupportedApps = [], this.eventClient = new Bi2(this, this.logger, e2 == null ? void 0 : e2.telemetryEnabled), this.setGlobalCore(this);
  }
...
function Zi2(t2, e2 = 24) {
  ...
  for (let r2 = 24 - e2; r2 < 24; r2++) {
    for (let s2 = 0; s2 < 10; s2++) n3[s2] = t2[s2] ^ t2[s2 + 10] ^ t2[s2 + 20] ^ t2[s2 + 30] ^ t2[s2 + 40];
    for (let s2 = 0; s2 < 10; s2 += 2) {
      const c4 = (s2 + 8) % 10, a2 = (s2 + 2) % 10, u3 = n3[a2], l5 = n3[a2 + 1], f7 = rr3(u3, l5, 1) ^ n3[c4], h4 = or3(u3, l5, 1) ^ n3[c4 + 1];
      for (let y6 = 0; y6 < 50; y6 += 10) t2[s2 + y6] ^= f7, t2[s2 + y6 + 1] ^= h4;
    }
    let o2 = t2[2], i3 = t2[3];
    for (let s2 = 0; s2 < 24; s2++) {
      const c4 = er3[s2], a2 = rr3(o2, i3, c4), u3 = or3(o2, i3, c4), l5 = tr3[s2];
      o2 = t2[l5], i3 = t2[l5 + 1], t2[l5] = a2, t2[l5 + 1] = u3;
    }
    for (let s2 = 0; s2 < 50; s2 += 10) {
      for (let c4 = 0; c4 < 10; c4++) n3[c4] = t2[s2 + c4];
...
var Es2 = (t2, e2) => {
  function n3(r2, ...o2) {
    if (tt3(r2), t2.nonceLength !== void 0) {
      const l5 = o2[0];
      if (!l5) throw new Error("nonce / iv required");
      t2.varSizeNonce ? tt3(l5) : tt3(l5, t2.nonceLength);
    }
    const i3 = t2.tagLength;
    ...
    return { encrypt(l5, f7) {
      if (a2) throw new Error("cannot encrypt() twice with same key + nonce");
      return a2 = true, tt3(l5), c4(s2.encrypt.length, f7), s2.encrypt(l5, f7);
    }, decrypt(l5, f7) {
      if (tt3(l5), i3 && l5.length < i3) throw new Error("invalid ciphertext length: smaller than tagLength=" + i3);
      return c4(s2.decrypt.length, f7), s2.decrypt(l5, f7);
    } };
  }
  return Object.assign(n3, t2), n3;
...
function Is2(t2, e2, n3, r2, o2, i3, s2, c4) {
  const a2 = o2.length, u3 = new Uint8Array(ge3), l5 = mt2(u3), f7 = Ye3(o2) && Ye3(i3), h4 = f7 ? mt2(o2) : Tr3, y6 = f7 ? mt2(i3) : Tr3;
  for (let E4 = 0; E4 < a2; s2++) {
    if (t2(e2, n3, r2, l5, s2, c4), s2 >= Ur3) throw new Error("arx: counter overflow");
    const p3 = Math.min(ge3, a2 - E4);
    if (f7 && p3 === ge3) {
      const d2 = E4 / 4;
      if (E4 % 4 !== 0) throw new Error("arx: invalid block position");
      for (let v3 = 0, m2; v3 < Bs2; v3++) m2 = d2 + v3, y6[m2] = h4[m2] ^ l5[v3];
      E4 += ge3;
      continue;
    }
    for (let d2 = 0, v3; d2 < p3; d2++) v3 = E4 + d2, i3[v3] = o2[v3] ^ u3[d2];
...
function Ns2(t2, e2) {
  ...
  if (typeof t2 != "function") throw new Error("core must be a function");
  return Fe3(o2), Fe3(s2), Ar3(i3), Ar3(n3), (c4, a2, u3, l5, f7 = 0) => {
    tt3(c4), tt3(a2), tt3(u3);
    const h4 = u3.length;
    if (l5 === void 0 && (l5 = new Uint8Array(h4)), tt3(l5), Fe3(f7), f7 < 0 || f7 >= Ur3) throw new Error("arx: counter overflow");
    if (l5.length < h4) throw new Error(`arx: output (${l5.length}) is shorter than data (${h4})`);
    const y6 = [];
    let E4 = c4.length, p3, d2;
    if (E4 === 32) y6.push(p3 = Ze3(c4)), d2 = As2;
    else if (E4 === 16 && n3) p3 = new Uint8Array(32), p3.set(c4), p3.set(c4, 16), d2 = Os2, y6.push(p3);
    else throw new Error(`arx: invalid 32-byte key, got length=${E4}`);
    Ye3(a2) || y6.push(a2 = Ze3(a2));
    const v3 = mt2(p3);
    if (r2) {
      if (a2.length !== 24) throw new Error("arx: extended nonce must be 24 bytes");
    ...
    const O4 = mt2(a2);
    return Is2(t2, d2, v3, O4, u3, l5, f7, s2), jt3(...y6), l5;
  };
}
...
var Us2 = class {
  constructor(e2) {
    ...
    const n3 = F3(e2, 0), r2 = F3(e2, 2), o2 = F3(e2, 4), i3 = F3(e2, 6), s2 = F3(e2, 8), c4 = F3(e2, 10), a2 = F3(e2, 12), u3 = F3(e2, 14);
    this.r[0] = n3 & 8191, this.r[1] = (n3 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o2 << 6) & 7939, this.r[3] = (o2 >>> 7 | i3 << 9) & 8191, this.r[4] = (i3 >>> 4 | s2 << 12) & 255, this.r[5] = s2 >>> 1 & 8190, this.r[6] = (s2 >>> 14 | c4 << 2) & 8191, this.r[7] = (c4 >>> 11 | a2 << 5) & 8065, this.r[8] = (a2 >>> 8 | u3 << 8) & 8191, this.r[9] = u3 >>> 5 & 127;
    for (let l5 = 0; l5 < 8; l5++) this.pad[l5] = F3(e2, 16 + 2 * l5);
  }
  process(e2, n3, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i3, r: s2 } = this, c4 = s2[0], a2 = s2[1], u3 = s2[2], l5 = s2[3], f7 = s2[4], h4 = s2[5], y6 = s2[6], E4 = s2[7], p3 = s2[8], d2 = s2[9], v3 = F3(e2, n3 + 0), m2 = F3(e2, n3 + 2), O4 = F3(e2, n3 + 4), N2 = F3(e2, n3 + 6), $2 = F3(e2, n3 + 8), B3 = F3(e2, n3 + 10), A3 = F3(e2, n3 + 12), T = F3(e2, n3 + 14);
    let S3 = i3[0] + (v3 & 8191), L2 = i3[1] + ((v3 >>> 13 | m2 << 3) & 8191), U4 = i3[2] + ((m2 >>> 10 | O4 << 6) & 8191), _2 = i3[3] + ((O4 >>> 7 | N2 << 9) & 8191), j2 = i3[4] + ((N2 >>> 4 | $2 << 12) & 8191), g = i3[5] + ($2 >>> 1 & 8191), w2 = i3[6] + (($2 >>> 14 | B3 << 2) & 8191), b2 = i3[7] + ((B3 >>> 11 | A3 << 5) & 8191), I2 = i3[8] + ((A3 >>> 8 | T << 8) & 8191), R3 = i3[9] + (T >>> 5 | o2), x2 = 0, C4 = x2 + S3 * c4 + L2 * (5 * d2) + U4 * (5 * p3) + _2 * (5 * E4) + j2 * (5 * y6);
    x2 = C4 >>> 13, C4 &= 8191, C4 += g * (5 * h4) + w2 * (5 * f7) + b2 * (5 * l5) + I2 * (5 * u3) + R3 * (5 * a2), x2 += C4 >>> 13, C4 &= 8191;
    let P3 = x2 + S3 * a2 + L2 * c4 + U4 * (5 * d2) + _2 * (5 * p3) + j2 * (5 * E4);
    x2 = P3 >>> 13, P3 &= 8191, P3 += g * (5 * y6) + w2 * (5 * h4) + b2 * (5 * f7) + I2 * (5 * l5) + R3 * (5 * u3), x2 += P3 >>> 13, P3 &= 8191;
...
function _s2(t2, e2, n3, r2, o2, i3 = 20) {
  let s2 = t2[0], c4 = t2[1], a2 = t2[2], u3 = t2[3], l5 = e2[0], f7 = e2[1], h4 = e2[2], y6 = e2[3], E4 = e2[4], p3 = e2[5], d2 = e2[6], v3 = e2[7], m2 = o2, O4 = n3[0], N2 = n3[1], $2 = n3[2], B3 = s2, A3 = c4, T = a2, S3 = u3, L2 = l5, U4 = f7, _2 = h4, j2 = y6, g = E4, w2 = p3, b2 = d2, I2 = v3, R3 = m2, x2 = O4, C4 = N2, P3 = $2;
  for (let M3 = 0; M3 < i3; M3 += 2) B3 = B3 + L2 | 0, R3 = V3(R3 ^ B3, 16), g = g + R3 | 0, L2 = V3(L2 ^ g, 12), B3 = B3 + L2 | 0, R3 = V3(R3 ^ B3, 8), g = g + R3 | 0, L2 = V3(L2 ^ g, 7), A3 = A3 + U4 | 0, x2 = V3(x2 ^ A3, 16), w2 = w2 + x2 | 0, U4 = V3(U4 ^ w2, 12), A3 = A3 + U4 | 0, x2 = V3(x2 ^ A3, 8), w2 = w2 + x2 | 0, U4 = V3(U4 ^ w2, 7), T = T + _2 | 0, C4 = V3(C4 ^ T, 16), b2 = b2 + C4 | 0, _2 = V3(_2 ^ b2, 12), T = T + _2 | 0, C4 = V3(C4 ^ T, 8), b2 = b2 + C4 | 0, _2 = V3(_2 ^ b2, 7), S3 = S3 + j2 | 0, P3 = V3(P3 ^ S3, 16), I2 = I2 + P3 | 0, j2 = V3(j2 ^ I2, 12), S3 = S3 + j2 | 0, P3 = V3(P3 ^ S3, 8), I2 = I2 + P3 | 0, j2 = V3(j2 ^ I2, 7), B3 = B3 + U4 | 0, P3 = V3(P3 ^ B3, 16), b2 = b2 + P3 | 0, U4 = V3(U4 ^ b2, 12), B3 = B3 + U4 | 0, P3 = V3(P3 ^ B3, 8), b2 = b2 + P3 | 0, U4 = V3(U4 ^ b2, 7), A3 = A3 + _2 | 0, R3 = V3(R3 ^ A3, 16), I2 = I2 + R3 | 0, _2 = V3(_2 ^ I2, 12), A3 = A3 + _2 | 0, R3 = V3(R3 ^ A3, 8), I2 = I2 + R3 | 0, _2 = V3(_2 ^ I2, 7), T = T + j2 | 0, x2 = V3(x2 ^ T, 16), g = g + x2 | 0, j2 = V3(j2 ^ g, 12), T = T + j2 | 0, x2 = V3(x2 ^ T, 8), g = g + x2 | 0, j2 = V3(j2 ^ g, 7), S3 = S3 + L2 | 0, C4 = V3(C4 ^ S3, 16), w2 = w2 + C4 | 0, L2 = V3(L2 ^ w2, 12), S3 = S3 + L2 | 0, C4 = V3(C4 ^ S3, 8), w2 = w2 + C4 | 0, L2 = V3(L2 ^ w2, 7);
  let k4 = 0;
  r2[k4++] = s2 + B3 | 0, r2[k4++] = c4 + A3 | 0, r2[k4++] = a2 + T | 0, r2[k4++] = u3 + S3 | 0, r2[k4++] = l5 + L2 | 0, r2[k4++] = f7 + U4 | 0, r2[k4++] = h4 + _2 | 0, r2[k4++] = y6 + j2 | 0, r2[k4++] = E4 + g | 0, r2[k4++] = p3 + w2 | 0, r2[k4++] = d2 + b2 | 0, r2[k4++] = v3 + I2 | 0, r2[k4++] = m2 + R3 | 0, r2[k4++] = O4 + x2 | 0, r2[k4++] = N2 + C4 | 0, r2[k4++] = $2 + P3 | 0;
}
...
function _r3(t2, e2, n3, r2, o2) {
  ...
  const c4 = new Uint8Array(16), a2 = gs2(c4);
  Ir3(a2, 0, BigInt(o2 ? o2.length : 0), true), Ir3(a2, 8, BigInt(r2.length), true), s2.update(c4);
  const u3 = s2.digest();
  return jt3(i3, c4), u3;
}
var Cs2 = (t2) => (e2, n3, r2) => ({ encrypt(i3, s2) {
  const c4 = i3.length;
  s2 = Br3(c4 + 16, s2, false), s2.set(i3);
  const a2 = s2.subarray(0, -16);
  t2(e2, n3, a2, a2, 1);
  const u3 = _r3(t2, e2, n3, a2, r2);
  return s2.set(u3, c4), jt3(u3), s2;
}, decrypt(i3, s2) {
  s2 = Br3(i3.length - 16, s2, false);
  const c4 = i3.subarray(0, -16), a2 = i3.subarray(-16), u3 = _r3(t2, e2, n3, c4, r2);
...
var qs3 = class extends ke3 {
  ...
  digestInto(e2) {
    ...
    const c4 = Pe3(e2), a2 = this.outputLen;
    if (a2 % 4) throw new Error("_sha2: outputLen should be aligned to 32bit");
    const u3 = a2 / 4, l5 = this.get();
    if (u3 > l5.length) throw new Error("_sha2: outputLen bigger than state");
    for (let f7 = 0; f7 < u3; f7++) c4.setUint32(4 * f7, l5[f7], i3);
...
var Fs2 = class extends qs3 {
  ...
  process(e2, n3) {
    ...
    for (let f7 = 16; f7 < 64; f7++) {
      const h4 = bt2[f7 - 15], y6 = bt2[f7 - 2], E4 = ct2(h4, 7) ^ ct2(h4, 18) ^ h4 >>> 3, p3 = ct2(y6, 17) ^ ct2(y6, 19) ^ y6 >>> 10;
      bt2[f7] = p3 + bt2[f7 - 7] + E4 + bt2[f7 - 16] | 0;
    }
    let { A: r2, B: o2, C: i3, D: s2, E: c4, F: a2, G: u3, H: l5 } = this;
    for (let f7 = 0; f7 < 64; f7++) {
      const h4 = ct2(c4, 6) ^ ct2(c4, 11) ^ ct2(c4, 25), y6 = l5 + h4 + Ds2(c4, a2, u3) + Ks2[f7] + bt2[f7] | 0, p3 = (ct2(r2, 2) ^ ct2(r2, 13) ^ ct2(r2, 22)) + Hs2(r2, o2, i3) | 0;
      l5 = u3, u3 = a2, a2 = c4, c4 = s2 + y6 | 0, s2 = i3, i3 = o2, o2 = r2, r2 = y6 + p3 | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, i3 = i3 + this.C | 0, s2 = s2 + this.D | 0, c4 = c4 + this.E | 0, a2 = a2 + this.F | 0, u3 = u3 + this.G | 0, l5 = l5 + this.H | 0, this.set(r2, o2, i3, s2, c4, a2, u3, l5);
  }
...
function Vt3(t2) {
  ...
  const r2 = new Uint8Array(n3);
  for (let o2 = 0, i3 = 0; o2 < n3; o2++, i3 += 2) {
    const s2 = Cr3(t2.charCodeAt(i3)), c4 = Cr3(t2.charCodeAt(i3 + 1));
    if (s2 === void 0 || c4 === void 0) {
      const a2 = t2[i3] + t2[i3 + 1];
      throw new Error('hex string expected, got non-hex character "' + a2 + '" at index ' + i3);
    }
...
function Vr3(t2, e2, n3) {
  ...
  const s2 = () => {
    r2.fill(1), o2.fill(0), i3 = 0;
  }, c4 = (...f7) => n3(o2, r2, ...f7), a2 = (f7 = Qe4()) => {
    o2 = c4(kr3([0]), f7), r2 = c4(), f7.length !== 0 && (o2 = c4(kr3([1]), f7), r2 = c4());
  }, u3 = () => {
    if (i3++ >= 1e3) throw new Error("drbg: tried 1000 values");
    let f7 = 0;
    const h4 = [];
...
function rc2(t2) {
  ...
  return function(c4, a2) {
    ...
    for (; !c4.eql(h4, c4.ONE); ) {
      ...
      let y6 = 1;
      for (let p3 = c4.sqr(h4); y6 < u3 && !c4.eql(p3, c4.ONE); y6++) p3 = c4.sqr(p3);
      const E4 = c4.pow(l5, H2 << BigInt(u3 - y6 - 1));
      l5 = c4.sqr(E4), f7 = c4.mul(f7, E4), h4 = c4.mul(h4, l5), u3 = y6;
    }
    return f7;
  };
...
function oc2(t2) {
  ...
  if (t2 % Dr3 === Mr3) {
    const e2 = (t2 - Mr3) / Dr3;
    return function(r2, o2) {
      const i3 = r2.mul(o2, At3), s2 = r2.pow(i3, e2), c4 = r2.mul(o2, s2), a2 = r2.mul(r2.mul(c4, At3), s2), u3 = r2.mul(c4, r2.sub(a2, r2.ONE));
      if (!r2.eql(r2.sqr(u3), o2)) throw new Error("Cannot find square root");
      return u3;
    };
  }
...
function Kr4(t2, e2, n3 = false, r2 = {}) {
  ...
  if (i3 > 2048) throw new Error("invalid field: expected ORDER of <= 2048 bytes");
  let s2;
  const c4 = Object.freeze({ ORDER: t2, isLE: n3, BITS: o2, BYTES: i3, MASK: Je3(o2), ZERO: q2, ONE: H2, create: (a2) => X2(a2, t2), isValid: (a2) => {
    if (typeof a2 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a2);
    return q2 <= a2 && a2 < t2;
  }, is0: (a2) => a2 === q2, isOdd: (a2) => (a2 & H2) === H2, neg: (a2) => X2(-a2, t2), eql: (a2, u3) => a2 === u3, sqr: (a2) => X2(a2 * a2, t2), add: (a2, u3) => X2(a2 + u3, t2), sub: (a2, u3) => X2(a2 - u3, t2), mul: (a2, u3) => X2(a2 * u3, t2), pow: (a2, u3) => cc2(c4, a2, u3), div: (a2, u3) => X2(a2 * nn3(u3, t2), t2), sqrN: (a2) => a2 * a2, addN: (a2, u3) => a2 + u3, subN: (a2, u3) => a2 - u3, mulN: (a2, u3) => a2 * u3, inv: (a2) => nn3(a2, t2), sqrt: r2.sqrt || ((a2) => (s2 || (s2 = oc2(t2)), s2(c4, a2))), invertBatch: (a2) => ac2(c4, a2), cmov: (a2, u3, l5) => l5 ? u3 : a2, toBytes: (a2) => n3 ? be3(a2, i3) : Mt3(a2, i3), fromBytes: (a2) => {
    if (a2.length !== i3) throw new Error("Field.fromBytes: expected " + i3 + " bytes, got " + a2.length);
...
function uc2(t2, e2, n3 = false) {
  ...
  if (r2 < 16 || r2 < i3 || r2 > 1024) throw new Error("expected " + i3 + "-1024 bytes of input, got " + r2);
  const s2 = n3 ? ee3(t2) : Ot3(t2), c4 = X2(s2, e2 - H2) + H2;
  return n3 ? be3(c4, o2) : Mt3(c4, o2);
}
var Zr3 = BigInt(0);
var ve2 = BigInt(1);
function rn3(t2, e2) {
...
function dc2(t2, e2) {
  return { constTimeNegate: rn3, hasPrecomputes(n3) {
    ...
    for (let h4 = 0; h4 < i3; h4++) {
      const y6 = h4 * s2;
      let E4 = Number(o2 & u3);
      o2 >>= f7, E4 > s2 && (E4 -= l5, o2 += ve2);
      const p3 = y6, d2 = y6 + Math.abs(E4) - 1, v3 = h4 % 2 !== 0, m2 = E4 < 0;
      E4 === 0 ? a2 = a2.add(rn3(v3, r2[p3])) : c4 = c4.add(rn3(m2, r2[d2]));
    }
    return { p: c4, f: a2 };
  }, wNAFUnsafe(n3, r2, o2, i3 = t2.ZERO) {
    const { windows: s2, windowSize: c4 } = on3(n3, e2), a2 = BigInt(2 ** n3 - 1), u3 = 2 ** n3, l5 = BigInt(n3);
    for (let f7 = 0; f7 < s2; f7++) {
      const h4 = f7 * c4;
      if (o2 === Zr3) break;
      let y6 = Number(o2 & a2);
      if (o2 >>= l5, y6 > c4 && (y6 -= u3, o2 += ve2), y6 === 0) continue;
      let E4 = r2[h4 + Math.abs(y6) - 1];
      y6 < 0 && (E4 = E4.negate()), i3 = i3.add(E4);
    }
    return i3;
...
function hc2(t2, e2, n3, r2) {
  ...
  const o2 = t2.ZERO, i3 = Pr3(BigInt(n3.length)), s2 = i3 > 12 ? i3 - 3 : i3 > 4 ? i3 - 2 : i3 ? 2 : 1, c4 = (1 << s2) - 1, a2 = new Array(c4 + 1).fill(o2), u3 = Math.floor((e2.BITS - 1) / s2) * s2;
  let l5 = o2;
  for (let f7 = u3; f7 >= 0; f7 -= s2) {
    a2.fill(o2);
    for (let y6 = 0; y6 < r2.length; y6++) {
...
function gc2(t2) {
  const e2 = pc2(t2), { P: n3 } = e2, r2 = (m2) => X2(m2, n3), o2 = e2.montgomeryBits, i3 = Math.ceil(o2 / 8), s2 = e2.nByteLength, c4 = e2.adjustScalarBytes || ((m2) => m2), a2 = e2.powPminus2 || ((m2) => Hr3(m2, n3 - BigInt(2), n3));
  function u3(m2, O4, N2) {
    const $2 = r2(m2 * (O4 - N2));
    return O4 = r2(O4 - $2), N2 = r2(N2 + $2), [O4, N2];
  }
  const l5 = (e2.a - BigInt(2)) / BigInt(4);
  function f7(m2, O4) {
    ft2("u", m2, Ht3, n3), ft2("scalar", O4, Ht3, n3);
    const N2 = O4, $2 = m2;
    let B3 = an3, A3 = Ht3, T = m2, S3 = an3, L2 = Ht3, U4;
    for (let j2 = BigInt(o2 - 1); j2 >= Ht3; j2--) {
      const g = N2 >> j2 & an3;
      L2 ^= g, U4 = u3(L2, B3, T), B3 = U4[0], T = U4[1], U4 = u3(L2, A3, S3), A3 = U4[0], S3 = U4[1], L2 = g;
      const w2 = B3 + A3, b2 = r2(w2 * w2), I2 = B3 - A3, R3 = r2(I2 * I2), x2 = b2 - R3, C4 = T + S3, P3 = T - S3, k4 = r2(P3 * w2), M3 = r2(C4 * I2), D2 = k4 + M3, z3 = k4 - M3;
      T = r2(D2 * D2), S3 = r2($2 * r2(z3 * z3)), B3 = r2(b2 * R3), A3 = r2(x2 * (b2 + r2(l5 * x2)));
  ...
  function y6(m2) {
    const O4 = et2("u coordinate", m2, i3);
    return s2 === 32 && (O4[31] &= 127), ee3(O4);
  }
  function E4(m2) {
    const O4 = et2("scalar", m2), N2 = O4.length;
    if (N2 !== i3 && N2 !== s2) {
      let $2 = "" + i3 + " or " + s2;
      throw new Error("invalid scalar, expected " + $2 + " bytes, got " + N2);
    }
...
BigInt(8);
function bc2(t2) {
  const e2 = BigInt(10), n3 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i3 = un3, c4 = t2 * t2 % i3 * t2 % i3, a2 = it3(c4, Xr3, i3) * c4 % i3, u3 = it3(a2, yc2, i3) * t2 % i3, l5 = it3(u3, wc2, i3) * u3 % i3, f7 = it3(l5, e2, i3) * l5 % i3, h4 = it3(f7, n3, i3) * f7 % i3, y6 = it3(h4, r2, i3) * h4 % i3, E4 = it3(y6, o2, i3) * y6 % i3, p3 = it3(E4, o2, i3) * y6 % i3, d2 = it3(p3, e2, i3) * l5 % i3;
  return { pow_p_5_8: it3(d2, Xr3, i3) * t2 % i3, b2: c4 };
}
function Ec2(t2) {
  return t2[0] &= 248, t2[31] &= 127, t2[31] |= 64, t2;
}
...
function Ac2(t2) {
  ...
  function a2(p3) {
    ...
    let N2;
    try {
      N2 = typeof p3 == "bigint" ? p3 : Ot3(et2("private key", p3, v3));
    } catch {
      throw new Error("invalid private key, expected hex or " + v3 + " bytes, got " + typeof p3);
    }
    return m2 && (N2 = X2(N2, O4)), ft2("private key", N2, K3, O4), N2;
  }
  function u3(p3) {
    if (!(p3 instanceof h4)) throw new Error("ProjectivePoint expected");
  }
  ...
  class h4 {
    ...
    double() {
      const { a: d2, b: v3 } = e2, m2 = n3.mul(v3, Qr3), { px: O4, py: N2, pz: $2 } = this;
      let B3 = n3.ZERO, A3 = n3.ZERO, T = n3.ZERO, S3 = n3.mul(O4, O4), L2 = n3.mul(N2, N2), U4 = n3.mul($2, $2), _2 = n3.mul(O4, N2);
      return _2 = n3.add(_2, _2), T = n3.mul(O4, $2), T = n3.add(T, T), B3 = n3.mul(d2, T), A3 = n3.mul(m2, U4), A3 = n3.add(B3, A3), B3 = n3.sub(L2, A3), A3 = n3.add(L2, A3), A3 = n3.mul(B3, A3), B3 = n3.mul(_2, B3), T = n3.mul(m2, T), U4 = n3.mul(d2, U4), _2 = n3.sub(S3, U4), _2 = n3.mul(d2, _2), _2 = n3.add(_2, T), T = n3.add(S3, S3), S3 = n3.add(T, S3), S3 = n3.add(S3, U4), S3 = n3.mul(S3, _2), A3 = n3.add(A3, S3), U4 = n3.mul(N2, $2), U4 = n3.add(U4, U4), S3 = n3.mul(U4, _2), B3 = n3.sub(B3, S3), T = n3.mul(U4, L2), T = n3.add(T, T), T = n3.add(T, T), new h4(B3, A3, T);
    }
    add(d2) {
    ...
    multiplyUnsafe(d2) {
      ...
      if (!v3 || E4.hasPrecomputes(this)) return E4.wNAFCachedUnsafe(this, d2, h4.normalizeZ);
      let { k1neg: N2, k1: $2, k2neg: B3, k2: A3 } = v3.splitScalar(d2), T = O4, S3 = O4, L2 = this;
      for (; $2 > dt2 || A3 > dt2; ) $2 & K3 && (T = T.add(L2)), A3 & K3 && (S3 = S3.add(L2)), L2 = L2.double(), $2 >>= K3, A3 >>= K3;
      return N2 && (T = T.negate()), B3 && (S3 = S3.negate()), S3 = new h4(n3.mul(S3.px, v3.beta), S3.py, S3.pz), T.add(S3);
    }
    multiply(d2) {
      const { endo: v3, n: m2 } = e2;
    ...
    multiplyAndAddUnsafe(d2, v3, m2) {
      const O4 = h4.BASE, N2 = (B3, A3) => A3 === dt2 || A3 === K3 || !B3.equals(O4) ? B3.multiplyUnsafe(A3) : B3.multiply(A3), $2 = N2(this, v3).add(N2(d2, m2));
      return $2.is0() ? void 0 : $2;
    }
    toAffine(d2) {
      return l5(this, d2);
    ...
    clearCofactor() {
      const { h: d2, clearCofactor: v3 } = e2;
      return d2 === K3 ? this : v3 ? v3(h4, this) : this.multiplyUnsafe(e2.h);
    }
    toRawBytes(d2 = true) {
  ...
  h4.BASE = new h4(e2.Gx, e2.Gy, n3.ONE), h4.ZERO = new h4(n3.ZERO, n3.ONE, n3.ZERO);
  const y6 = e2.nBitLength, E4 = dc2(h4, e2.endo ? Math.ceil(y6 / 2) : y6);
  return { CURVE: e2, ProjectivePoint: h4, normPrivateKeyToScalar: a2, weierstrassEquation: s2, isWithinCurveOrder: c4 };
}
function Bc2(t2) {
  const e2 = Wr3(t2);
...
function Ic2(t2) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u3, weierstrassEquation: l5, isWithinCurveOrder: f7 } = Ac2({ ...e2, toBytes(g, w2, b2) {
    const I2 = w2.toAffine(), R3 = n3.toBytes(I2.x), x2 = ne3;
    return Ct3("isCompressed", b2), b2 ? x2(Uint8Array.from([w2.hasEvenY() ? 2 : 3]), R3) : x2(Uint8Array.from([4]), R3, n3.toBytes(I2.y));
  }, fromBytes(g) {
    const w2 = g.length, b2 = g[0], I2 = g.subarray(1);
    if (w2 === o2 && (b2 === 2 || b2 === 3)) {
      const R3 = Ot3(I2);
      if (!Ee3(R3, K3, n3.ORDER)) throw new Error("Point is not on curve");
      const x2 = l5(R3);
      let C4;
      try {
        C4 = n3.sqrt(x2);
  ...
  class d2 {
    ...
    assertValidity() {
      ft2("r", this.r, K3, r2), ft2("s", this.s, K3, r2);
    }
    addRecoveryBit(w2) {
      return new d2(this.r, this.s, w2);
    }
    recoverPublicKey(w2) {
      const { r: b2, s: I2, recovery: R3 } = this, x2 = B3(et2("msgHash", w2));
      if (R3 == null || ![0, 1, 2, 3].includes(R3)) throw new Error("recovery id invalid");
      const C4 = R3 === 2 || R3 === 3 ? b2 + e2.n : b2;
      if (C4 >= n3.ORDER) throw new Error("recovery id 2 or 3 invalid");
      const P3 = (R3 & 1) === 0 ? "02" : "03", k4 = a2.fromHex(P3 + h4(C4)), M3 = c4(C4), D2 = s2(-x2 * M3), z3 = s2(I2 * M3), Z2 = a2.BASE.multiplyAndAddUnsafe(k4, D2, z3);
  ...
  function S3(g, w2, b2 = L2) {
    ...
    const { hash: I2, randomBytes: R3 } = e2;
    let { lowS: x2, prehash: C4, extraEntropy: P3 } = b2;
    x2 == null && (x2 = true), g = et2("msgHash", g), Jr3(b2), C4 && (g = et2("prehashed msgHash", I2(g)));
    const k4 = B3(g), M3 = u3(w2), D2 = [T(M3), T(k4)];
    if (P3 != null && P3 !== false) {
      const W2 = P3 === true ? R3(n3.BYTES) : P3;
      D2.push(et2("extraEntropy", W2));
    }
    const z3 = ne3(...D2), Z2 = k4;
    function st2(W2) {
      const J2 = $2(W2);
      if (!f7(J2)) return;
      const Be3 = c4(J2), zt2 = a2.BASE.multiply(J2).toAffine(), vt = s2(zt2.x);
      ...
      const Zt2 = s2(Be3 * s2(Z2 + vt * M3));
      if (Zt2 === dt2) return;
      let Ut2 = (zt2.x === vt ? 0 : 2) | Number(zt2.y & K3), vn2 = Zt2;
      return x2 && y6(Zt2) && (vn2 = E4(Zt2), Ut2 ^= 1), new d2(vt, vn2, Ut2);
    }
    return { seed: z3, k2sig: st2 };
  }
  ...
  function _2(g, w2, b2 = L2) {
    const { seed: I2, k2sig: R3 } = S3(g, w2, b2), x2 = e2;
    return Vr3(x2.hash.outputLen, x2.nByteLength, x2.hmac)(I2, R3);
  }
  a2.BASE._setWindowSize(8);
  function j2(g, w2, b2, I2 = U4) {
    var _a;
    ...
    if (P3 !== void 0 && P3 !== "compact" && P3 !== "der") throw new Error("format must be compact or der");
    const k4 = typeof R3 == "string" || St3(R3), M3 = !k4 && !P3 && typeof R3 == "object" && R3 !== null && typeof R3.r == "bigint" && typeof R3.s == "bigint";
    if (!k4 && !M3) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    let D2, z3;
    try {
      if (M3 && (D2 = new d2(R3.r, R3.s)), k4) {
...
var controller14 = {
  ...
  getParams() {
    ...
    const invalidSourceToken = !((_c3 = state21.sourceToken) == null ? void 0 : _c3.address) || !((_d = state21.sourceToken) == null ? void 0 : _d.decimals) || !NumberUtil.bigNumber(state21.sourceTokenAmount).gt(0);
    const invalidSourceTokenAmount = !state21.sourceTokenAmount;
    return {
      networkAddress,
      fromAddress: address,
      fromCaipAddress: caipAddress,
      sourceTokenAddress: (_e3 = state21.sourceToken) == null ? void 0 : _e3.address,
    ...
    try {
      ...
      EventsController.sendEvent({
        ...
        properties: {
          ...
          swapToToken: ((_c3 = SwapController.state.toToken) == null ? void 0 : _c3.symbol) || "",
  ...
  async sendTransactionForSwap(data) {
    var _a, _b, _c3, _d, _e3, _f, _g, _h, _i4, _j, _k, _l, _m, _n2;
    if (!data) {
      return void 0;
    }
    ...
    const snackbarSuccessMessage = `Swapped ${(_c3 = state21.sourceToken) == null ? void 0 : _c3.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_d = state21.toToken) == null ? void 0 : _d.symbol}`;
    if (isAuthConnector) {
      RouterController.pushTransactionStack({
        onSuccess() {
          RouterController.replace("Account");
    ...
    try {
      const forceUpdateAddresses = [(_e3 = state21.sourceToken) == null ? void 0 : _e3.address, (_f = state21.toToken) == null ? void 0 : _f.address].join(",");
      ...
      EventsController.sendEvent({
        ...
        properties: {
          ...
          swapToToken: ((_i4 = SwapController.state.toToken) == null ? void 0 : _i4.symbol) || "",
          swapFromAmount: SwapController.state.sourceTokenAmount || "",
          swapToAmount: SwapController.state.toTokenAmount || "",
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-VXBTXSEP.js.map
