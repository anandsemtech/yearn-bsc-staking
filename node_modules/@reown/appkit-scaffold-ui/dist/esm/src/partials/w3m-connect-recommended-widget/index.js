...
import { AssetUtil, ConnectionController, ConnectorController, CoreHelperUtil, OptionsController, RouterController } from '@reown/appkit-controllers';
...
let W3mConnectRecommendedWidget = class W3mConnectRecommendedWidget extends LitElement {
    ...
    render() {
        ...
        const isEmailEnabled = Boolean(OptionsController.state.features?.email || OptionsController.state.remoteFeatures?.email);
        const isSocialsEnabled = (Array.isArray(OptionsController.state.features?.socials) &&
